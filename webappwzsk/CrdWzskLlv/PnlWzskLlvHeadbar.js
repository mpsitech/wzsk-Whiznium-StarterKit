/**
  * \file PnlWzskLlvHeadbar.js
  * web client functionality for panel PnlWzskLlvHeadbar
...
function getMenAvail(short) {
	return(retrieveSi(srcdoc, "StatShrWzskLlvHeadbar", "Men" + short + "Avail") == "true");
};

function getMenCptwidth(short) {
	return(parseInt(retrieveSi(srcdoc, "StgInfWzskLlvHeadbar", "Men" + short + "Cptwidth")));
};
...
function mergeDpchEngData(dom) {
	...
	if (updateSrcblock(dom, "DpchEngWzskLlvHeadbarData", "StgInfWzskLlvHeadbar", srcdoc)) mask.push("stginf");
	if (updateSrcblock(dom, "DpchEngWzskLlvHeadbarData", "TagWzskLlvHeadbar", srcdoc)) mask.push("tag");
...
function handleDpchAppInitReply() {
	...
	if (doc.req.readyState == 4) {
		...
		if (blk) {
			if (blk.nodeName == "DpchEngWzskLlvHeadbarData") {
