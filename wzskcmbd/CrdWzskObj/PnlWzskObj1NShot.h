...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzskQObj1NShot* rst = NULL, QryWzskObj1NShot::StatShr* statshrqry = NULL, QryWzskObj1NShot::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
