/**
	* \file QryWzskPrsADetail.h
	* job handler for job QryWzskPrsADetail (declarations)
...
#ifndef QRYWZSKPRSADETAIL_H
#define QRYWZSKPRSADETAIL_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWzskPrsADetail QryWzskPrsADetail::StatApp
#define StatShrQryWzskPrsADetail QryWzskPrsADetail::StatShr
#define StgIacQryWzskPrsADetail QryWzskPrsADetail::StgIac

/**
	* QryWzskPrsADetail
	*/
class QryWzskPrsADetail : public JobWzsk {
...
public:
	QryWzskPrsADetail(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~QryWzskPrsADetail();
...
public:
	...
	WzskQPrsADetail* getRecByJnum(const Sbecore::uint jnum);
...
private:
	bool handleCallWzskPrsAdetMod_prsEq(DbsWzsk* dbswzsk, const Sbecore::ubigint jrefTrig);
