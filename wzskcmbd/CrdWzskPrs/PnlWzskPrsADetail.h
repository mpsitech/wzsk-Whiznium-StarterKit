/**
	* \file PnlWzskPrsADetail.h
	* job handler for job PnlWzskPrsADetail (declarations)
	* \author Catherine Johnson
	* \date created: 23 Jul 2020
	* \date modified: 23 Jul 2020
	*/

#ifndef PNLWZSKPRSADETAIL_H
#define PNLWZSKPRSADETAIL_H
...
#define VecVWzskPrsADetailDo PnlWzskPrsADetail::VecVDo

#define ContInfWzskPrsADetail PnlWzskPrsADetail::ContInf
#define StatAppWzskPrsADetail PnlWzskPrsADetail::StatApp
#define StatShrWzskPrsADetail PnlWzskPrsADetail::StatShr
#define StgIacWzskPrsADetail PnlWzskPrsADetail::StgIac
#define TagWzskPrsADetail PnlWzskPrsADetail::Tag

#define DpchAppWzskPrsADetailData PnlWzskPrsADetail::DpchAppData
#define DpchAppWzskPrsADetailDo PnlWzskPrsADetail::DpchAppDo
#define DpchEngWzskPrsADetailData PnlWzskPrsADetail::DpchEngData

/**
	* PnlWzskPrsADetail
	*/
class PnlWzskPrsADetail : public JobWzsk {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzskQPrsADetail* rst = NULL, QryWzskPrsADetail::StatShr* statshrqry = NULL, QryWzskPrsADetail::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWzskPrsADetail(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~PnlWzskPrsADetail();
...
public:
	...
	QryWzskPrsADetail* qry;

	WzskAMPersonDetail recPrsAdet;
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWzsk* dbswzsk, QryWzskPrsADetail::StgIac* _stgiacqry, DpchEngWzsk** dpcheng);
