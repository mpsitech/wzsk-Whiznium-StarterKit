/**
	* \file QryWzskPrsList_blks.cpp
	* job handler for job QryWzskPrsList (implementation of blocks)
...
/******************************************************************************
 class QryWzskPrsList::VecVOrd
 ******************************************************************************/

uint QryWzskPrsList::VecVOrd::getIx(
			const string& sref
		) {
...
void QryWzskPrsList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class QryWzskPrsList::StatApp
 ******************************************************************************/

void QryWzskPrsList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWzskPrsList";
...
void QryWzskPrsList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWzskPrsList";
...
/******************************************************************************
 class QryWzskPrsList::StatShr
 ******************************************************************************/

QryWzskPrsList::StatShr::StatShr(
			const uint ntot
...
void QryWzskPrsList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWzskPrsList";
...
void QryWzskPrsList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWzskPrsList";
...
set<uint> QryWzskPrsList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWzskPrsList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWzskPrsList::StgIac
 ******************************************************************************/

QryWzskPrsList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWzskPrsList::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWzskPrsList"];}();
...
bool QryWzskPrsList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWzskPrsList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWzskPrsList";
...
void QryWzskPrsList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWzskPrsList";
...
void QryWzskPrsList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWzskPrsList";
...
set<uint> QryWzskPrsList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWzskPrsList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
