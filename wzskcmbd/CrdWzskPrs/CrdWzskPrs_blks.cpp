...
void CrdWzskPrs::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void CrdWzskPrs::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void CrdWzskPrs::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void CrdWzskPrs::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzskPrsDo"];}();
...
void CrdWzskPrs::DpchEngData::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzskPrsData"] = Json::Value(Json::objectValue);
