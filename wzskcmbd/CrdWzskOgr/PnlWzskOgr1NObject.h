...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzskQOgr1NObject* rst = NULL, QryWzskOgr1NObject::StatShr* statshrqry = NULL, QryWzskOgr1NObject::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
