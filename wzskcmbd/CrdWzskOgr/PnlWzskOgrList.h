/**
	* \file PnlWzskOgrList.h
	* job handler for job PnlWzskOgrList (declarations)
	* \author Catherine Johnson
	* \date created: 16 Sep 2020
	* \date modified: 16 Sep 2020
	*/

#ifndef PNLWZSKOGRLIST_H
#define PNLWZSKOGRLIST_H
...
#define VecVWzskOgrListDo PnlWzskOgrList::VecVDo

#define ContIacWzskOgrList PnlWzskOgrList::ContIac
#define ContInfWzskOgrList PnlWzskOgrList::ContInf
#define StatShrWzskOgrList PnlWzskOgrList::StatShr
#define StgIacWzskOgrList PnlWzskOgrList::StgIac
#define TagWzskOgrList PnlWzskOgrList::Tag

#define DpchAppWzskOgrListData PnlWzskOgrList::DpchAppData
#define DpchAppWzskOgrListDo PnlWzskOgrList::DpchAppDo
#define DpchEngWzskOgrListData PnlWzskOgrList::DpchEngData

/**
	* PnlWzskOgrList
	*/
class PnlWzskOgrList : public JobWzsk {
...
public:
	...
	public:
		StgIac(const Sbecore::uint TcoSrfWidth = 100, const Sbecore::uint TcoTitWidth = 100, const Sbecore::uint TcoSupWidth = 100);
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, Sbecore::Xmlio::Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzskQOgrList* rst = NULL, QryWzskOgrList::StatShr* statshrqry = NULL, QryWzskOgrList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWzskOgrList(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~PnlWzskOgrList();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWzsk* dbswzsk, QryWzskOgrList::StgIac* _stgiacqry, DpchEngWzsk** dpcheng);
