...
void QryWzskFilList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void QryWzskFilList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWzskFilList";
...
void QryWzskFilList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWzskFilList";
...
void QryWzskFilList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWzskFilList";
...
void QryWzskFilList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWzskFilList";
...
void QryWzskFilList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
