...
#define VecVQryWzskFilListOrd QryWzskFilList::VecVOrd

#define StatAppQryWzskFilList QryWzskFilList::StatApp
#define StatShrQryWzskFilList QryWzskFilList::StatShr
#define StgIacQryWzskFilList QryWzskFilList::StgIac

/**
	* QryWzskFilList
	*/
class QryWzskFilList : public JobWzsk {
...
public:
	QryWzskFilList(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~QryWzskFilList();
...
public:
	...
	WzskQFilList* getRecByJnum(const Sbecore::uint jnum);
