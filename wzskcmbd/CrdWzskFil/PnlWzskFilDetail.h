...
public:
	...
	public:
		...
		static const Sbecore::uint BUTCNTEDITCLICK = 5;
		static const Sbecore::uint BUTMIMEDITCLICK = 6;
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const Sbecore::uint ixWzskVExpstate = VecWzskVExpstate::MIND, const bool LstCluAlt = true, const bool PupCntAlt = false, const bool PupMimAlt = false, const Sbecore::uint LstCluNumFirstdisp = 1);
	...
	public:
		...
		static const Sbecore::uint PUPCNTACTIVE = 9;
		static const Sbecore::uint TXFCNTVALID = 10;
		static const Sbecore::uint BUTCNTEDITAVAIL = 11;
		static const Sbecore::uint TXFACVACTIVE = 12;
		static const Sbecore::uint TXFANMACTIVE = 13;
		static const Sbecore::uint PUPMIMACTIVE = 14;
		static const Sbecore::uint TXFMIMVALID = 15;
		static const Sbecore::uint BUTMIMEDITAVAIL = 16;
		static const Sbecore::uint TXFSIZACTIVE = 17;
		static const Sbecore::uint TXFCMTACTIVE = 18;

	public:
		StatShr(const bool ButSaveAvail = true, const bool ButSaveActive = true, const bool TxfFnmActive = true, const bool LstCluActive = true, const bool ButCluViewActive = true, const bool ButCluClusterAvail = true, const bool ButCluUnclusterAvail = true, const bool TxtReuActive = true, const bool PupCntActive = true, const bool TxfCntValid = false, const bool ButCntEditAvail = true, const bool TxfAcvActive = true, const bool TxfAnmActive = true, const bool PupMimActive = true, const bool TxfMimValid = false, const bool ButMimEditAvail = true, const bool TxfSizActive = true, const bool TxfCmtActive = true);
