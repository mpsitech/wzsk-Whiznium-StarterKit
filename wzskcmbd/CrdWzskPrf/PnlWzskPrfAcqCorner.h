/**
	...
	* job handler for job PnlWzskPrfAcqCorner (declarations)
...
#include "JobWzskAcqCorner.h" // IP include.cust --- LINE
...
/**
	* PnlWzskPrfAcqCorner
	*/
class PnlWzskPrfAcqCorner : public JobWzsk {
...
public:
	PnlWzskPrfAcqCorner(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~PnlWzskPrfAcqCorner();
...
public:
	...
	// IP vars.cust --- BEGIN
	JobWzskAcqCorner::Stg stgjobwzskacqcorner;
	// IP vars.cust --- END

public:
	// IP cust --- BEGIN
	void getPref(JobWzskAcqCorner::Stg*& _stgjobwzskacqcorner);
