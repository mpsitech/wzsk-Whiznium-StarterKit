/**
	* \file PnlWzskPrfAcqPreview_blks.cpp
	* job handler for job PnlWzskPrfAcqPreview (implementation of blocks)
...
bool PnlWzskPrfAcqPreview::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWzskPrfAcqPreview"];}();
...
void PnlWzskPrfAcqPreview::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWzskPrfAcqPreview::StatShr::writeJSON(
	...
	if (difftag.length() == 0) difftag = "StatShrWzskPrfAcqPreview";
...
void PnlWzskPrfAcqPreview::StatShr::writeXML(
	...
	else itemtag = "StatitemShrWzskPrfAcqPreview";
...
void PnlWzskPrfAcqPreview::Tag::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWzskPrfAcqPreview";
...
void PnlWzskPrfAcqPreview::Tag::writeXML(
			const uint ixWzskVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWzskPrfAcqPreview";
...
PnlWzskPrfAcqPreview::DpchAppData::DpchAppData() :
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKPRFACQPREVIEWDATA)
		{
};
...
void PnlWzskPrfAcqPreview::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzskPrfAcqPreviewData"];}();
...
void PnlWzskPrfAcqPreview::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzskPrfAcqPreviewData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzskPrfAcqPreview::DpchAppDo::DpchAppDo() :
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKPRFACQPREVIEWDO)
		{
	ixVDo = 0;
};
...
void PnlWzskPrfAcqPreview::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzskPrfAcqPreviewDo"];}();
...
void PnlWzskPrfAcqPreview::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzskPrfAcqPreviewDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzskPrfAcqPreview::DpchEngData::DpchEngData(
			...
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKPRFACQPREVIEWDATA, jref)
		{
...
void PnlWzskPrfAcqPreview::DpchEngData::merge(
			DpchEngWzsk* dpcheng
		) {
...
void PnlWzskPrfAcqPreview::DpchEngData::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzskPrfAcqPreviewData"] = Json::Value(Json::objectValue);
...
void PnlWzskPrfAcqPreview::DpchEngData::writeXML(
			const uint ixWzskVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWzskPrfAcqPreviewData");
