/**
	...
	* job handler for job PnlWzskPrfActVistorot (declarations)
...
#include "JobWzskActVistorot.h" // IP include.cust --- LINE
...
/**
	...
	*/
class PnlWzskPrfActVistorot : public JobWzsk {
...
public:
	PnlWzskPrfActVistorot(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~PnlWzskPrfActVistorot();
...
public:
	...
	// IP vars.cust --- BEGIN
	JobWzskActVistorot::Stg stgjobwzskactvistorot;
	// IP vars.cust --- END

public:
	// IP cust --- BEGIN
	void getPref(JobWzskActVistorot::Stg*& _stgjobwzskactvistorot);
