...
bool PnlWzskUsgList::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWzskUsgList"];}();
...
void PnlWzskUsgList::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWzskUsgList::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWzskUsgList";
...
void PnlWzskUsgList::ContInf::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWzskUsgList";
...
void PnlWzskUsgList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWzskUsgList";
...
void PnlWzskUsgList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWzskUsgList";
...
bool PnlWzskUsgList::StgIac::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWzskUsgList"];}();
...
void PnlWzskUsgList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWzskUsgList::Tag::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWzskUsgList";
...
void PnlWzskUsgList::Tag::writeXML(
			const uint ixWzskVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWzskUsgList";
...
PnlWzskUsgList::DpchAppData::DpchAppData() :
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKUSGLISTDATA)
		{
};
...
void PnlWzskUsgList::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzskUsgListData"];}();
...
void PnlWzskUsgList::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzskUsgListData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzskUsgList::DpchAppDo::DpchAppDo() :
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKUSGLISTDO)
		{
	ixVDo = 0;
};
...
void PnlWzskUsgList::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzskUsgListDo"];}();
...
void PnlWzskUsgList::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzskUsgListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzskUsgList::DpchEngData::DpchEngData(
			...
			, QryWzskUsgList::StatShr* statshrqry
			, QryWzskUsgList::StgIac* stgiacqry
			, const set<uint>& mask
		) :
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKUSGLISTDATA, jref)
		{
...
void PnlWzskUsgList::DpchEngData::merge(
			DpchEngWzsk* dpcheng
		) {
...
void PnlWzskUsgList::DpchEngData::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzskUsgListData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWzskUsgList::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWzskUsgList::DpchEngData::writeXML(
			const uint ixWzskVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWzskUsgListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzsk");
		...
		if (has(STATAPPQRY)) QryWzskUsgList::StatApp::writeXML(wr);
