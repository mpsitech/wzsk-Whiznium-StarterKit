/**
	* \file QryWzskUsgList.h
	* job handler for job QryWzskUsgList (declarations)
...
#ifndef QRYWZSKUSGLIST_H
#define QRYWZSKUSGLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWzskUsgListOrd QryWzskUsgList::VecVOrd

#define StatAppQryWzskUsgList QryWzskUsgList::StatApp
#define StatShrQryWzskUsgList QryWzskUsgList::StatShr
#define StgIacQryWzskUsgList QryWzskUsgList::StgIac

/**
	* QryWzskUsgList
	*/
class QryWzskUsgList : public JobWzsk {
...
public:
	QryWzskUsgList(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~QryWzskUsgList();
...
public:
	...
	WzskQUsgList* getRecByJnum(const Sbecore::uint jnum);
