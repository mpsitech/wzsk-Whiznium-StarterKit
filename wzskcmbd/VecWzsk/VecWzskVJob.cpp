...
uint VecWzskVJob::getIx(
	...
	if (s == "jobwzsksrcarty") return JOBWZSKSRCARTY;
	...
	if (s == "pnlwzskllvtermarty") return PNLWZSKLLVTERMARTY;
...
string VecWzskVJob::getSref(
	...
	if (ix == JOBWZSKSRCARTY) return("JobWzskSrcArty");
	...
	if (ix == PNLWZSKLLVTERMARTY) return("PnlWzskLlvTermArty");
