/**
	* \file VecWzskVMimetype.cpp
	* vector VecWzskVMimetype (implementation)
...
/******************************************************************************
 namespace VecWzskVMimetype
 ******************************************************************************/

uint VecWzskVMimetype::getIx(
			const string& sref
		) {
...
string VecWzskVMimetype::getSref(
			const uint ix
		) {
...
string VecWzskVMimetype::getTitle(
			const uint ix
		) {
