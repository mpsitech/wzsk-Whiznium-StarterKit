...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzskQSes1NShot* rst = NULL, QryWzskSes1NShot::StatShr* statshrqry = NULL, QryWzskSes1NShot::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
