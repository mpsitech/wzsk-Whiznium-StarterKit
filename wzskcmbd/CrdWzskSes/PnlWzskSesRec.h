/**
	...
	* job handler for job PnlWzskSesRec (declarations)
...
/**
	* PnlWzskSesRec
	*/
class PnlWzskSesRec : public JobWzsk {
...
public:
	...
	public:
		static void writeJSON(Json::Value& sup, std::string difftag = "", const bool initdoneDetail = false, const bool initdone1NShot = false);
		static void writeXML(xmlTextWriter* wr, std::string difftag = "", bool shorttags = true, const bool initdoneDetail = false, const bool initdone1NShot = false);
	};
	...
	public:
		StatShr(const Sbecore::uint ixWzskVExpstate = VecWzskVExpstate::REGD, const Sbecore::ubigint jrefDetail = 0, const Sbecore::ubigint jref1NShot = 0, const bool ButRegularizeActive = true);
...
public:
	PnlWzskSesRec(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~PnlWzskSesRec();
