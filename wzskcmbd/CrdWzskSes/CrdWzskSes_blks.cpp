...
void CrdWzskSes::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void CrdWzskSes::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
...
void CrdWzskSes::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void CrdWzskSes::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzskSesDo"];}();
...
void CrdWzskSes::DpchEngData::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzskSesData"] = Json::Value(Json::objectValue);
