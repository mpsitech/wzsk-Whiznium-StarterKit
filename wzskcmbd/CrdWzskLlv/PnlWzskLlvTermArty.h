/**
	* \file PnlWzskLlvTermArty.h
	* job handler for job PnlWzskLlvTermArty (declarations)
...
#ifndef PNLWZSKLLVTERMARTY_H
#define PNLWZSKLLVTERMARTY_H
...
#define VecVWzskLlvTermArtyDo PnlWzskLlvTermArty::VecVDo

#define ContIacWzskLlvTermArty PnlWzskLlvTermArty::ContIac
#define ContInfWzskLlvTermArty PnlWzskLlvTermArty::ContInf
#define StatShrWzskLlvTermArty PnlWzskLlvTermArty::StatShr
#define TagWzskLlvTermArty PnlWzskLlvTermArty::Tag

#define DpchAppWzskLlvTermArtyData PnlWzskLlvTermArty::DpchAppData
#define DpchAppWzskLlvTermArtyDo PnlWzskLlvTermArty::DpchAppDo
#define DpchEngWzskLlvTermArtyData PnlWzskLlvTermArty::DpchEngData

/**
	* PnlWzskLlvTermArty
	*/
class PnlWzskLlvTermArty : public JobWzsk {
...
public:
	PnlWzskLlvTermArty(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~PnlWzskLlvTermArty();
...
private:
	bool handleCallWzskClaimChgFromSrcarty(DbsWzsk* dbswzsk);
