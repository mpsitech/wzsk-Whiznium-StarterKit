/**
	* \file PnlWzskLlvTermIcicle.h
	* job handler for job PnlWzskLlvTermIcicle (declarations)
...
#ifndef PNLWZSKLLVTERMICICLE_H
#define PNLWZSKLLVTERMICICLE_H
...
#define VecVWzskLlvTermIcicleDo PnlWzskLlvTermIcicle::VecVDo

#define ContIacWzskLlvTermIcicle PnlWzskLlvTermIcicle::ContIac
#define ContInfWzskLlvTermIcicle PnlWzskLlvTermIcicle::ContInf
#define StatShrWzskLlvTermIcicle PnlWzskLlvTermIcicle::StatShr
#define TagWzskLlvTermIcicle PnlWzskLlvTermIcicle::Tag

#define DpchAppWzskLlvTermIcicleData PnlWzskLlvTermIcicle::DpchAppData
#define DpchAppWzskLlvTermIcicleDo PnlWzskLlvTermIcicle::DpchAppDo
#define DpchEngWzskLlvTermIcicleData PnlWzskLlvTermIcicle::DpchEngData

/**
	* PnlWzskLlvTermIcicle
	*/
class PnlWzskLlvTermIcicle : public JobWzsk {
...
public:
	PnlWzskLlvTermIcicle(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~PnlWzskLlvTermIcicle();
...
private:
	bool handleCallWzskClaimChgFromSrcicicle(DbsWzsk* dbswzsk);
