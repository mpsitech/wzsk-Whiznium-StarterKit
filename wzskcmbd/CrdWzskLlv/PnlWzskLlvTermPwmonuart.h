/**
	* \file PnlWzskLlvTermPwmonuart.h
	* job handler for job PnlWzskLlvTermPwmonuart (declarations)
...
#ifndef PNLWZSKLLVTERMPWMONUART_H
#define PNLWZSKLLVTERMPWMONUART_H
...
#define VecVWzskLlvTermPwmonuartDo PnlWzskLlvTermPwmonuart::VecVDo

#define ContIacWzskLlvTermPwmonuart PnlWzskLlvTermPwmonuart::ContIac
#define ContInfWzskLlvTermPwmonuart PnlWzskLlvTermPwmonuart::ContInf
#define StatShrWzskLlvTermPwmonuart PnlWzskLlvTermPwmonuart::StatShr
#define TagWzskLlvTermPwmonuart PnlWzskLlvTermPwmonuart::Tag

#define DpchAppWzskLlvTermPwmonuartData PnlWzskLlvTermPwmonuart::DpchAppData
#define DpchAppWzskLlvTermPwmonuartDo PnlWzskLlvTermPwmonuart::DpchAppDo
#define DpchEngWzskLlvTermPwmonuartData PnlWzskLlvTermPwmonuart::DpchEngData

/**
	* PnlWzskLlvTermPwmonuart
	*/
class PnlWzskLlvTermPwmonuart : public JobWzsk {
...
public:
	PnlWzskLlvTermPwmonuart(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~PnlWzskLlvTermPwmonuart();
...
private:
	bool handleCallWzskClaimChgFromSrcpwmonuart(DbsWzsk* dbswzsk);
