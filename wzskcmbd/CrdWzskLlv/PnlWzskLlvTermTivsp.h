/**
	...
	* job handler for job PnlWzskLlvTermTivsp (declarations)
...
/**
	* PnlWzskLlvTermTivsp
	*/
class PnlWzskLlvTermTivsp : public JobWzsk {
...
public:
	PnlWzskLlvTermTivsp(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~PnlWzskLlvTermTivsp();
...
private:
	bool handleCallWzskClaimChgFromSrctivsp(DbsWzsk* dbswzsk);
