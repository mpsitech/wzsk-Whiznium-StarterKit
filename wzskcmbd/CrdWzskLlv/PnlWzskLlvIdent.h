/**
	...
	* job handler for job PnlWzskLlvIdent (declarations)
...
/**
	* PnlWzskLlvIdent
	*/
class PnlWzskLlvIdent : public JobWzsk {
...
public:
	PnlWzskLlvIdent(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~PnlWzskLlvIdent();
