/**
	* \file PnlWzskLlvTermUvbdvk_blks.cpp
	* job handler for job PnlWzskLlvTermUvbdvk (implementation of blocks)
...
bool PnlWzskLlvTermUvbdvk::ContIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["ContIacWzskLlvTermUvbdvk"];}();
...
void PnlWzskLlvTermUvbdvk::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWzskLlvTermUvbdvk::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWzskLlvTermUvbdvk";
...
void PnlWzskLlvTermUvbdvk::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWzskLlvTermUvbdvk";
...
void PnlWzskLlvTermUvbdvk::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWzskLlvTermUvbdvk";
...
void PnlWzskLlvTermUvbdvk::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWzskLlvTermUvbdvk";
...
void PnlWzskLlvTermUvbdvk::Tag::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWzskLlvTermUvbdvk";
...
void PnlWzskLlvTermUvbdvk::Tag::writeXML(
			const uint ixWzskVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWzskLlvTermUvbdvk";
...
PnlWzskLlvTermUvbdvk::DpchAppData::DpchAppData() :
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKLLVTERMUVBDVKDATA)
		{
};
...
void PnlWzskLlvTermUvbdvk::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzskLlvTermUvbdvkData"];}();
...
void PnlWzskLlvTermUvbdvk::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzskLlvTermUvbdvkData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzskLlvTermUvbdvk::DpchAppDo::DpchAppDo() :
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKLLVTERMUVBDVKDO)
		{
	ixVDo = 0;
};
...
void PnlWzskLlvTermUvbdvk::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzskLlvTermUvbdvkDo"];}();
...
void PnlWzskLlvTermUvbdvk::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzskLlvTermUvbdvkDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzskLlvTermUvbdvk::DpchEngData::DpchEngData(
			...
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKLLVTERMUVBDVKDATA, jref)
		{
...
void PnlWzskLlvTermUvbdvk::DpchEngData::merge(
			DpchEngWzsk* dpcheng
		) {
...
void PnlWzskLlvTermUvbdvk::DpchEngData::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzskLlvTermUvbdvkData"] = Json::Value(Json::objectValue);
...
void PnlWzskLlvTermUvbdvk::DpchEngData::writeXML(
			const uint ixWzskVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWzskLlvTermUvbdvkData");
