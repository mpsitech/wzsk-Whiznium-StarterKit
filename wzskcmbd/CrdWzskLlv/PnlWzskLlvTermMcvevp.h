/**
	* \file PnlWzskLlvTermMcvevp.h
	* job handler for job PnlWzskLlvTermMcvevp (declarations)
...
#ifndef PNLWZSKLLVTERMMCVEVP_H
#define PNLWZSKLLVTERMMCVEVP_H
...
#define VecVWzskLlvTermMcvevpDo PnlWzskLlvTermMcvevp::VecVDo

#define ContIacWzskLlvTermMcvevp PnlWzskLlvTermMcvevp::ContIac
#define ContInfWzskLlvTermMcvevp PnlWzskLlvTermMcvevp::ContInf
#define StatShrWzskLlvTermMcvevp PnlWzskLlvTermMcvevp::StatShr
#define TagWzskLlvTermMcvevp PnlWzskLlvTermMcvevp::Tag

#define DpchAppWzskLlvTermMcvevpData PnlWzskLlvTermMcvevp::DpchAppData
#define DpchAppWzskLlvTermMcvevpDo PnlWzskLlvTermMcvevp::DpchAppDo
#define DpchEngWzskLlvTermMcvevpData PnlWzskLlvTermMcvevp::DpchEngData

/**
	* PnlWzskLlvTermMcvevp
	*/
class PnlWzskLlvTermMcvevp : public JobWzsk {
...
public:
	PnlWzskLlvTermMcvevp(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~PnlWzskLlvTermMcvevp();
...
private:
	bool handleCallWzskClaimChgFromSrcmcvevp(DbsWzsk* dbswzsk);
