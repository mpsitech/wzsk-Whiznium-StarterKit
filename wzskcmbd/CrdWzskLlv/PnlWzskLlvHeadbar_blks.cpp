...
void PnlWzskLlvHeadbar::StgInf::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgInfWzskLlvHeadbar";
...
void PnlWzskLlvHeadbar::StgInf::writeXML(
			const uint ixWzskVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "StgitemInfWzskLlvHeadbar";
...
void PnlWzskLlvHeadbar::Tag::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWzskLlvHeadbar";
...
void PnlWzskLlvHeadbar::Tag::writeXML(
			const uint ixWzskVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWzskLlvHeadbar";
...
PnlWzskLlvHeadbar::DpchEngData::DpchEngData(
			...
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKLLVHEADBARDATA, jref)
		{
...
void PnlWzskLlvHeadbar::DpchEngData::merge(
			DpchEngWzsk* dpcheng
		) {
...
void PnlWzskLlvHeadbar::DpchEngData::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzskLlvHeadbarData"] = Json::Value(Json::objectValue);
...
void PnlWzskLlvHeadbar::DpchEngData::writeXML(
			const uint ixWzskVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWzskLlvHeadbarData");
