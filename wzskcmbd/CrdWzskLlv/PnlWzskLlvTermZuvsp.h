/**
	* \file PnlWzskLlvTermZuvsp.h
	* job handler for job PnlWzskLlvTermZuvsp (declarations)
...
#ifndef PNLWZSKLLVTERMZUVSP_H
#define PNLWZSKLLVTERMZUVSP_H
...
#define VecVWzskLlvTermZuvspDo PnlWzskLlvTermZuvsp::VecVDo

#define ContIacWzskLlvTermZuvsp PnlWzskLlvTermZuvsp::ContIac
#define ContInfWzskLlvTermZuvsp PnlWzskLlvTermZuvsp::ContInf
#define StatShrWzskLlvTermZuvsp PnlWzskLlvTermZuvsp::StatShr
#define TagWzskLlvTermZuvsp PnlWzskLlvTermZuvsp::Tag

#define DpchAppWzskLlvTermZuvspData PnlWzskLlvTermZuvsp::DpchAppData
#define DpchAppWzskLlvTermZuvspDo PnlWzskLlvTermZuvsp::DpchAppDo
#define DpchEngWzskLlvTermZuvspData PnlWzskLlvTermZuvsp::DpchEngData

/**
	* PnlWzskLlvTermZuvsp
	*/
class PnlWzskLlvTermZuvsp : public JobWzsk {

public:
	/**
		* VecVDo (full: VecVWzskLlvTermZuvspDo)
		*/
	class VecVDo {
	...
	/**
	  * ContIac (full: ContIacWzskLlvTermZuvsp)
	  */
	...
	/**
	  * ContInf (full: ContInfWzskLlvTermZuvsp)
	  */
	...
	/**
		* StatShr (full: StatShrWzskLlvTermZuvsp)
		*/
	...
	/**
		* DpchAppData (full: DpchAppWzskLlvTermZuvspData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppWzskLlvTermZuvspDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngWzskLlvTermZuvspData)
		*/
...
public:
	PnlWzskLlvTermZuvsp(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~PnlWzskLlvTermZuvsp();
...
private:
	bool handleCallWzskClaimChgFromSrczuvsp(DbsWzsk* dbswzsk);
