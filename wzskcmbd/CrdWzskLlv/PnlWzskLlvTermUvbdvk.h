/**
	* \file PnlWzskLlvTermUvbdvk.h
	* job handler for job PnlWzskLlvTermUvbdvk (declarations)
...
#ifndef PNLWZSKLLVTERMUVBDVK_H
#define PNLWZSKLLVTERMUVBDVK_H
...
#define VecVWzskLlvTermUvbdvkDo PnlWzskLlvTermUvbdvk::VecVDo

#define ContIacWzskLlvTermUvbdvk PnlWzskLlvTermUvbdvk::ContIac
#define ContInfWzskLlvTermUvbdvk PnlWzskLlvTermUvbdvk::ContInf
#define StatShrWzskLlvTermUvbdvk PnlWzskLlvTermUvbdvk::StatShr
#define TagWzskLlvTermUvbdvk PnlWzskLlvTermUvbdvk::Tag

#define DpchAppWzskLlvTermUvbdvkData PnlWzskLlvTermUvbdvk::DpchAppData
#define DpchAppWzskLlvTermUvbdvkDo PnlWzskLlvTermUvbdvk::DpchAppDo
#define DpchEngWzskLlvTermUvbdvkData PnlWzskLlvTermUvbdvk::DpchEngData

/**
	* PnlWzskLlvTermUvbdvk
	*/
class PnlWzskLlvTermUvbdvk : public JobWzsk {
...
public:
	PnlWzskLlvTermUvbdvk(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~PnlWzskLlvTermUvbdvk();
...
private:
	bool handleCallWzskClaimChgFromSrcuvbdvk(DbsWzsk* dbswzsk);
