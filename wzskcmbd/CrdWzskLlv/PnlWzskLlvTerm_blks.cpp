...
bool PnlWzskLlvTerm::ContIac::readJSON(
			Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	Json::Value& me = sup;
	if (addbasetag) me = sup["ContIacWzskLlvTerm"];
...
void PnlWzskLlvTerm::ContIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWzskLlvTerm::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWzskLlvTerm";
...
void PnlWzskLlvTerm::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfWzskLlvTerm";
...
void PnlWzskLlvTerm::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWzskLlvTerm";
...
void PnlWzskLlvTerm::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "StatitemShrWzskLlvTerm";
...
void PnlWzskLlvTerm::Tag::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWzskLlvTerm";
...
void PnlWzskLlvTerm::Tag::writeXML(
			const uint ixWzskVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWzskLlvTerm";
...
PnlWzskLlvTerm::DpchAppData::DpchAppData() :
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKLLVTERMDATA)
		{
};
...
void PnlWzskLlvTerm::DpchAppData::readJSON(
			Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	Json::Value& me = sup;
	if (addbasetag) me = sup["DpchAppWzskLlvTermData"];
...
void PnlWzskLlvTerm::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzskLlvTermData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzskLlvTerm::DpchAppDo::DpchAppDo() :
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKLLVTERMDO)
		{
	ixVDo = 0;
};
...
void PnlWzskLlvTerm::DpchAppDo::readJSON(
			Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	Json::Value& me = sup;
	if (addbasetag) me = sup["DpchAppWzskLlvTermDo"];
...
void PnlWzskLlvTerm::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzskLlvTermDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzskLlvTerm::DpchEngData::DpchEngData(
			...
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKLLVTERMDATA, jref)
		{
...
void PnlWzskLlvTerm::DpchEngData::merge(
			DpchEngWzsk* dpcheng
		) {
...
void PnlWzskLlvTerm::DpchEngData::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzskLlvTermData"] = Json::Value(Json::objectValue);
...
void PnlWzskLlvTerm::DpchEngData::writeXML(
			const uint ixWzskVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWzskLlvTermData");
