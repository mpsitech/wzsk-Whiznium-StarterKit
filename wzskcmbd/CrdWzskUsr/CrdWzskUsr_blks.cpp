/**
	* \file CrdWzskUsr_blks.cpp
	* job handler for job CrdWzskUsr (implementation of blocks)
...
void CrdWzskUsr::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
void CrdWzskUsr::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWzskUsr";
...
void CrdWzskUsr::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWzskUsr";
...
void CrdWzskUsr::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
	...
	if (difftag.length() == 0) difftag = "StatAppWzskUsr";
...
void CrdWzskUsr::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWzskVReqitmode
	...
	else itemtag = "StatitemAppWzskUsr";
...
void CrdWzskUsr::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWzskUsr";
...
void CrdWzskUsr::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWzskUsr";
...
void CrdWzskUsr::Tag::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWzskUsr";
...
CrdWzskUsr::DpchAppDo::DpchAppDo() :
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKUSRDO)
		{
	ixVDo = 0;
};
...
void CrdWzskUsr::DpchAppDo::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzskUsrDo"];}();
...
void CrdWzskUsr::DpchAppDo::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzskUsrDo");
	else
...
CrdWzskUsr::DpchEngData::DpchEngData(
			...
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKUSRDATA, jref)
		{
...
void CrdWzskUsr::DpchEngData::merge(
			DpchEngWzsk* dpcheng
		) {
...
void CrdWzskUsr::DpchEngData::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzskUsrData"] = Json::Value(Json::objectValue);
...
void CrdWzskUsr::DpchEngData::writeXML(
			const uint ixWzskVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWzskUsrData");
