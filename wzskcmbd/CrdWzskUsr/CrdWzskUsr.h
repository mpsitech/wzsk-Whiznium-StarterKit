/**
	* \file CrdWzskUsr.h
	* job handler for job CrdWzskUsr (declarations)
...
#define VecVWzskUsrDo CrdWzskUsr::VecVDo
#define VecVWzskUsrSge CrdWzskUsr::VecVSge

#define ContInfWzskUsr CrdWzskUsr::ContInf
#define StatAppWzskUsr CrdWzskUsr::StatApp
#define StatShrWzskUsr CrdWzskUsr::StatShr
#define TagWzskUsr CrdWzskUsr::Tag

#define DpchAppWzskUsrDo CrdWzskUsr::DpchAppDo
#define DpchEngWzskUsrData CrdWzskUsr::DpchEngData

/**
	* CrdWzskUsr
	*/
class CrdWzskUsr : public JobWzsk {
...
public:
	CrdWzskUsr(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale, const Sbecore::ubigint ref = 0);
	~CrdWzskUsr();
...
public:
	...
	PnlWzskUsrList* pnllist;
	PnlWzskUsrHeadbar* pnlheadbar;
	PnlWzskUsrRec* pnlrec;
