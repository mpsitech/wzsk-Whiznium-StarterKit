/**
	* \file PnlWzskUsrAAccess_blks.cpp
	* job handler for job PnlWzskUsrAAccess (implementation of blocks)
...
void PnlWzskUsrAAccess::ContInf::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "ContInfWzskUsrAAccess";
...
void PnlWzskUsrAAccess::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	else itemtag = "ContitemInfWzskUsrAAccess";
...
void PnlWzskUsrAAccess::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint ixWzskVExpstate
		) {
	if (difftag.length() == 0) difftag = "StatAppWzskUsrAAccess";
...
void PnlWzskUsrAAccess::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint ixWzskVExpstate
	...
	else itemtag = "StatitemAppWzskUsrAAccess";
...
void PnlWzskUsrAAccess::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrWzskUsrAAccess";
...
void PnlWzskUsrAAccess::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrWzskUsrAAccess";
...
bool PnlWzskUsrAAccess::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacWzskUsrAAccess"];}();
...
void PnlWzskUsrAAccess::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
...
void PnlWzskUsrAAccess::Tag::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "TagWzskUsrAAccess";
...
void PnlWzskUsrAAccess::Tag::writeXML(
			const uint ixWzskVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
	...
	else itemtag = "TagitemWzskUsrAAccess";
...
PnlWzskUsrAAccess::DpchAppData::DpchAppData() :
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKUSRAACCESSDATA)
		{
};
...
void PnlWzskUsrAAccess::DpchAppData::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzskUsrAAccessData"];}();
...
void PnlWzskUsrAAccess::DpchAppData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzskUsrAAccessData");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzskUsrAAccess::DpchAppDo::DpchAppDo() :
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKUSRAACCESSDO)
		{
	ixVDo = 0;
};
...
void PnlWzskUsrAAccess::DpchAppDo::readJSON(
			const Json::Value& sup
			, bool addbasetag
		) {
	clear();
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["DpchAppWzskUsrAAccessDo"];}();
...
void PnlWzskUsrAAccess::DpchAppDo::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppWzskUsrAAccessDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzskUsrAAccess::DpchEngData::DpchEngData(
			...
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKUSRAACCESSDATA, jref)
		{
...
void PnlWzskUsrAAccess::DpchEngData::merge(
			DpchEngWzsk* dpcheng
		) {
...
void PnlWzskUsrAAccess::DpchEngData::writeJSON(
			const uint ixWzskVLocale
			, Json::Value& sup
		) {
	Json::Value& me = sup["DpchEngWzskUsrAAccessData"] = Json::Value(Json::objectValue);
	...
	if (has(STATAPPQRY)) QryWzskUsrAAccess::StatApp::writeJSON(me);
	if (has(STATSHRQRY)) statshrqry.writeJSON(me);
	if (has(STGIACQRY)) stgiacqry.writeJSON(me);
};

void PnlWzskUsrAAccess::DpchEngData::writeXML(
			const uint ixWzskVLocale
			, xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngWzskUsrAAccessData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzsk");
		...
		if (has(STATAPPQRY)) QryWzskUsrAAccess::StatApp::writeXML(wr);
