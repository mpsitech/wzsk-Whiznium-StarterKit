...
#define QRYWZSKUSRLIST_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVQryWzskUsrListOrd QryWzskUsrList::VecVOrd

#define StatAppQryWzskUsrList QryWzskUsrList::StatApp
#define StatShrQryWzskUsrList QryWzskUsrList::StatShr
#define StgIacQryWzskUsrList QryWzskUsrList::StgIac

/**
	* QryWzskUsrList
	*/
class QryWzskUsrList : public JobWzsk {
...
public:
	QryWzskUsrList(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~QryWzskUsrList();
...
public:
	...
	WzskQUsrList* getRecByJnum(const Sbecore::uint jnum);
