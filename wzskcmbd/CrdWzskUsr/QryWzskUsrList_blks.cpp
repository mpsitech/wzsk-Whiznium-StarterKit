...
/******************************************************************************
 class QryWzskUsrList::VecVOrd
 ******************************************************************************/

uint QryWzskUsrList::VecVOrd::getIx(
			const string& sref
		) {
...
void QryWzskUsrList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class QryWzskUsrList::StatApp
 ******************************************************************************/

void QryWzskUsrList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWzskUsrList";
...
void QryWzskUsrList::StatApp::writeXML(
	...
	else itemtag = "StatitemAppQryWzskUsrList";
...
/******************************************************************************
 class QryWzskUsrList::StatShr
 ******************************************************************************/

QryWzskUsrList::StatShr::StatShr(
			const uint ntot
...
void QryWzskUsrList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWzskUsrList";
...
void QryWzskUsrList::StatShr::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWzskUsrList";
...
set<uint> QryWzskUsrList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWzskUsrList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWzskUsrList::StgIac
 ******************************************************************************/

QryWzskUsrList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWzskUsrList::StgIac::readJSON(
	...
	const Json::Value& me = [&]{if (!addbasetag) return sup; return sup["StgIacQryWzskUsrList"];}();
...
bool QryWzskUsrList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWzskUsrList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWzskUsrList";
...
void QryWzskUsrList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWzskUsrList";
...
void QryWzskUsrList::StgIac::writeXML(
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWzskUsrList";
...
set<uint> QryWzskUsrList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWzskUsrList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
