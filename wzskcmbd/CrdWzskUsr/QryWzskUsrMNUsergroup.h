...
#ifndef QRYWZSKUSRMNUSERGROUP_H
#define QRYWZSKUSRMNUSERGROUP_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define StatAppQryWzskUsrMNUsergroup QryWzskUsrMNUsergroup::StatApp
#define StatShrQryWzskUsrMNUsergroup QryWzskUsrMNUsergroup::StatShr
#define StgIacQryWzskUsrMNUsergroup QryWzskUsrMNUsergroup::StgIac

/**
	* QryWzskUsrMNUsergroup
	*/
class QryWzskUsrMNUsergroup : public JobWzsk {
...
public:
	QryWzskUsrMNUsergroup(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~QryWzskUsrMNUsergroup();
...
public:
	...
	WzskQUsrMNUsergroup* getRecByJnum(const Sbecore::uint jnum);
