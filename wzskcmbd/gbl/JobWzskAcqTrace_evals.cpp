/**
	* \file JobWzskAcqTrace_evals.cpp
	* job handler for job JobWzskAcqTrace (implementation of availability/activation evaluation)
...
bool JobWzskAcqTrace::evalSrcdcvspConstr(
			DbsWzsk* dbswzsk
		) {
...
bool JobWzskAcqTrace::evalSrctivspConstr(
			DbsWzsk* dbswzsk
		) {
...
bool JobWzskAcqTrace::evalSrczuvspConstr(
			DbsWzsk* dbswzsk
		) {
