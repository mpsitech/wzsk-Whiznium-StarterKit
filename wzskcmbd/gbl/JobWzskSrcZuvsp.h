/**
	* \file JobWzskSrcZuvsp.h
	* job handler for job JobWzskSrcZuvsp (declarations)
...
#ifndef JOBWZSKSRCZUVSP_H
#define JOBWZSKSRCZUVSP_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVJobWzskSrcZuvspSge JobWzskSrcZuvsp::VecVSge

#define StgJobWzskSrcZuvsp JobWzskSrcZuvsp::Stg

#define ShrdatJobWzskSrcZuvsp JobWzskSrcZuvsp::Shrdat

/**
	* JobWzskSrcZuvsp
	*/
class JobWzskSrcZuvsp : public CsjobWzsk {

public:
	/**
		* VecVSge (full: VecVJobWzskSrcZuvspSge)
		*/
	class VecVSge {
	...
	/**
		* Shrdat (full: ShrdatJobWzskSrcZuvsp)
		*/
...
public:
	JobWzskSrcZuvsp(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~JobWzskSrcZuvsp();
