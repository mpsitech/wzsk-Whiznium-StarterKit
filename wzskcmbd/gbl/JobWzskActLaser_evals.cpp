/**
	* \file JobWzskActLaser_evals.cpp
	* job handler for job JobWzskActLaser (implementation of availability/activation evaluation)
...
bool JobWzskActLaser::evalSrcdcvspConstr(
			DbsWzsk* dbswzsk
		) {
...
bool JobWzskActLaser::evalSrctivspConstr(
			DbsWzsk* dbswzsk
		) {
...
bool JobWzskActLaser::evalSrczuvspConstr(
			DbsWzsk* dbswzsk
		) {
