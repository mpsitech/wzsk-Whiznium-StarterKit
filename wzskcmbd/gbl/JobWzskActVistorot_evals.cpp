/**
	* \file JobWzskActVistorot_evals.cpp
	* job handler for job JobWzskActVistorot (implementation of availability/activation evaluation)
...
bool JobWzskActVistorot::evalSrcdcvspConstr(
			DbsWzsk* dbswzsk
		) {
...
bool JobWzskActVistorot::evalSrctivspConstr(
			DbsWzsk* dbswzsk
		) {
...
bool JobWzskActVistorot::evalSrczuvspConstr(
			DbsWzsk* dbswzsk
		) {
