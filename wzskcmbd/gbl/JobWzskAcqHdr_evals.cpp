/**
	* \file JobWzskAcqHdr_evals.cpp
	* job handler for job JobWzskAcqHdr (implementation of availability/activation evaluation)
...
bool JobWzskAcqHdr::evalSrcdcvspConstr(
			DbsWzsk* dbswzsk
		) {
...
bool JobWzskAcqHdr::evalSrctivspConstr(
			DbsWzsk* dbswzsk
		) {
...
bool JobWzskAcqHdr::evalSrczuvspConstr(
			DbsWzsk* dbswzsk
		) {
