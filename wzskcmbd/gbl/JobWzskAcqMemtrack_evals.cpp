/**
	* \file JobWzskAcqMemtrack_evals.cpp
	* job handler for job JobWzskAcqMemtrack (implementation of availability/activation evaluation)
...
bool JobWzskAcqMemtrack::evalSrcdcvspConstr(
			DbsWzsk* dbswzsk
		) {
...
bool JobWzskAcqMemtrack::evalSrctivspConstr(
			DbsWzsk* dbswzsk
		) {
...
bool JobWzskAcqMemtrack::evalSrczuvspConstr(
			DbsWzsk* dbswzsk
		) {
