/**
	* \file JobWzskActRotary_evals.cpp
	* job handler for job JobWzskActRotary (implementation of availability/activation evaluation)
...
bool JobWzskActRotary::evalSrcdcvspConstr(
			DbsWzsk* dbswzsk
		) {
...
bool JobWzskActRotary::evalSrctivspConstr(
			DbsWzsk* dbswzsk
		) {
...
bool JobWzskActRotary::evalSrczuvspConstr(
			DbsWzsk* dbswzsk
		) {
