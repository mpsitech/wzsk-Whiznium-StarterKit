/**
	* \file JobWzskSrcArty.h
	* job handler for job JobWzskSrcArty (declarations)
...
#ifndef JOBWZSKSRCARTY_H
#define JOBWZSKSRCARTY_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVJobWzskSrcArtySge JobWzskSrcArty::VecVSge

#define StgJobWzskSrcArty JobWzskSrcArty::Stg

#define ShrdatJobWzskSrcArty JobWzskSrcArty::Shrdat

/**
	* JobWzskSrcArty
	*/
class JobWzskSrcArty : public CsjobWzsk {

public:
	/**
		* VecVSge (full: VecVJobWzskSrcArtySge)
		*/
	class VecVSge {
	...
	/**
		* Shrdat (full: ShrdatJobWzskSrcArty)
		*/
...
public:
	JobWzskSrcArty(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~JobWzskSrcArty();
...
public:
	// IP cust --- IBEGIN
	/**
		* Claim (full: ClaimJobWzskSrcArty)
		*/
