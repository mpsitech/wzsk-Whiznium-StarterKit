/**
	* \file JobWzskSrcUzediocc.h
	* job handler for job JobWzskSrcUzediocc (declarations)
...
#ifndef JOBWZSKSRCUZEDIOCC_H
#define JOBWZSKSRCUZEDIOCC_H

// IP include.spec --- INSERT

// IP include.cust --- INSERT

#define VecVJobWzskSrcUzedioccSge JobWzskSrcUzediocc::VecVSge

#define StgJobWzskSrcUzediocc JobWzskSrcUzediocc::Stg

#define ShrdatJobWzskSrcUzediocc JobWzskSrcUzediocc::Shrdat

/**
	* JobWzskSrcUzediocc
	*/
class JobWzskSrcUzediocc : public CsjobWzsk {

public:
	/**
		* VecVSge (full: VecVJobWzskSrcUzedioccSge)
		*/
	class VecVSge {
	...
	/**
		* Stg (full: StgJobWzskSrcUzediocc)
		*/
	...
	public:
		Stg(const std::string& path = "/dev/uzediocc");
	...
	/**
		* Shrdat (full: ShrdatJobWzskSrcUzediocc)
		*/
...
public:
	JobWzskSrcUzediocc(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~JobWzskSrcUzediocc();
