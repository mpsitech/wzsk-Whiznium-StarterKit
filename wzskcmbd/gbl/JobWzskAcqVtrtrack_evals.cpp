/**
	* \file JobWzskAcqVtrtrack_evals.cpp
	* job handler for job JobWzskAcqVtrtrack (implementation of availability/activation evaluation)
...
bool JobWzskAcqVtrtrack::evalSrcdcvspConstr(
			DbsWzsk* dbswzsk
		) {
...
bool JobWzskAcqVtrtrack::evalSrctivspConstr(
			DbsWzsk* dbswzsk
		) {
...
bool JobWzskAcqVtrtrack::evalSrczuvspConstr(
			DbsWzsk* dbswzsk
		) {
