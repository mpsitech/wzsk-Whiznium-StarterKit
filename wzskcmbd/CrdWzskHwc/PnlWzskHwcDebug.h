/**
	* \file PnlWzskHwcDebug.h
	* job handler for job PnlWzskHwcDebug (declarations)
...
#ifndef PNLWZSKHWCDEBUG_H
#define PNLWZSKHWCDEBUG_H
...
#define VecVWzskHwcDebugDo PnlWzskHwcDebug::VecVDo

#define ContIacWzskHwcDebug PnlWzskHwcDebug::ContIac
#define ContInfWzskHwcDebug PnlWzskHwcDebug::ContInf
#define StatShrWzskHwcDebug PnlWzskHwcDebug::StatShr
#define TagWzskHwcDebug PnlWzskHwcDebug::Tag

#define DpchAppWzskHwcDebugData PnlWzskHwcDebug::DpchAppData
#define DpchAppWzskHwcDebugDo PnlWzskHwcDebug::DpchAppDo
#define DpchEngWzskHwcDebugData PnlWzskHwcDebug::DpchEngData

/**
	* PnlWzskHwcDebug
	*/
class PnlWzskHwcDebug : public JobWzsk {

public:
	/**
		* VecVDo (full: VecVWzskHwcDebugDo)
		*/
	class VecVDo {
	...
	/**
	  * ContIac (full: ContIacWzskHwcDebug)
	  */
	...
	/**
	  * ContInf (full: ContInfWzskHwcDebug)
	  */
	...
	/**
		* StatShr (full: StatShrWzskHwcDebug)
		*/
	...
	/**
		* DpchAppData (full: DpchAppWzskHwcDebugData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppWzskHwcDebugDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngWzskHwcDebugData)
		*/
...
public:
	PnlWzskHwcDebug(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~PnlWzskHwcDebug();
