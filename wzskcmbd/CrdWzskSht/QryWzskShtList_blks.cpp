/**
	* \file QryWzskShtList_blks.cpp
	* job handler for job QryWzskShtList (implementation of blocks)
...
/******************************************************************************
 class QryWzskShtList::VecVOrd
 ******************************************************************************/

uint QryWzskShtList::VecVOrd::getIx(
			const string& sref
		) {
...
void QryWzskShtList::VecVOrd::fillFeed(
			Feed& feed
		) {
	feed.clear();
...
/******************************************************************************
 class QryWzskShtList::StatApp
 ******************************************************************************/

void QryWzskShtList::StatApp::writeJSON(
			Json::Value& sup
			, string difftag
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryWzskShtList";
...
void QryWzskShtList::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	else itemtag = "StatitemAppQryWzskShtList";
...
/******************************************************************************
 class QryWzskShtList::StatShr
 ******************************************************************************/

QryWzskShtList::StatShr::StatShr(
			const uint ntot
...
void QryWzskShtList::StatShr::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StatShrQryWzskShtList";
...
void QryWzskShtList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryWzskShtList";
...
set<uint> QryWzskShtList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWzskShtList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWzskShtList::StgIac
 ******************************************************************************/

QryWzskShtList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWzskShtList::StgIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWzskShtList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWzskShtList";
...
void QryWzskShtList::StgIac::writeJSON(
			Json::Value& sup
			, string difftag
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWzskShtList";
...
void QryWzskShtList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	...
	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWzskShtList";
...
set<uint> QryWzskShtList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWzskShtList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
