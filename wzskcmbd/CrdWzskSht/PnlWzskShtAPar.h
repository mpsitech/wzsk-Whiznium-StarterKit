/**
	* \file PnlWzskShtAPar.h
	* job handler for job PnlWzskShtAPar (declarations)
	* \author Catherine Johnson
	* \date created: 6 Oct 2020
	* \date modified: 6 Oct 2020
	*/

#ifndef PNLWZSKSHTAPAR_H
#define PNLWZSKSHTAPAR_H
...
#define VecVWzskShtAParDo PnlWzskShtAPar::VecVDo

#define ContInfWzskShtAPar PnlWzskShtAPar::ContInf
#define StatAppWzskShtAPar PnlWzskShtAPar::StatApp
#define StatShrWzskShtAPar PnlWzskShtAPar::StatShr
#define StgIacWzskShtAPar PnlWzskShtAPar::StgIac
#define TagWzskShtAPar PnlWzskShtAPar::Tag

#define DpchAppWzskShtAParData PnlWzskShtAPar::DpchAppData
#define DpchAppWzskShtAParDo PnlWzskShtAPar::DpchAppDo
#define DpchEngWzskShtAParData PnlWzskShtAPar::DpchEngData

/**
	* PnlWzskShtAPar
	*/
class PnlWzskShtAPar : public JobWzsk {
...
public:
	...
	public:
		DpchEngData(const Sbecore::ubigint jref = 0, ContInf* continf = NULL, Sbecore::Xmlio::Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListWzskQShtAPar* rst = NULL, QryWzskShtAPar::StatShr* statshrqry = NULL, QryWzskShtAPar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
...
public:
	PnlWzskShtAPar(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~PnlWzskShtAPar();
...
private:
	...
	void handleDpchAppDataStgiacqry(DbsWzsk* dbswzsk, QryWzskShtAPar::StgIac* _stgiacqry, DpchEngWzsk** dpcheng);
