/**
	* \file CrdWzskSht.h
	* job handler for job CrdWzskSht (declarations)
...
#define VecVWzskShtDo CrdWzskSht::VecVDo
#define VecVWzskShtSge CrdWzskSht::VecVSge

#define ContInfWzskSht CrdWzskSht::ContInf
#define StatAppWzskSht CrdWzskSht::StatApp
#define StatShrWzskSht CrdWzskSht::StatShr
#define TagWzskSht CrdWzskSht::Tag

#define DpchAppWzskShtDo CrdWzskSht::DpchAppDo
#define DpchEngWzskShtData CrdWzskSht::DpchEngData

/**
	* CrdWzskSht
	*/
class CrdWzskSht : public JobWzsk {
...
public:
	CrdWzskSht(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale, const Sbecore::ubigint ref = 0, const Sbecore::uint ixWzskVPreset = VecWzskVPreset::VOID, const Sbecore::ubigint preUref = 0);
	~CrdWzskSht();
...
public:
	...
	PnlWzskShtList* pnllist;
	PnlWzskShtHeadbar* pnlheadbar;
	PnlWzskShtRec* pnlrec;
