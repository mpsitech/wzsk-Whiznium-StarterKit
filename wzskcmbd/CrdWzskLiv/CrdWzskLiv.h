...
#define ContInfWzskLiv CrdWzskLiv::ContInf
#define StatAppWzskLiv CrdWzskLiv::StatApp
#define StatShrWzskLiv CrdWzskLiv::StatShr
#define TagWzskLiv CrdWzskLiv::Tag

#define DpchAppWzskLivDo CrdWzskLiv::DpchAppDo
#define DpchEngWzskLivData CrdWzskLiv::DpchEngData

/**
	* CrdWzskLiv
	*/
class CrdWzskLiv : public JobWzsk {
...
public:
	CrdWzskLiv(XchgWzsk* xchg, DbsWzsk* dbswzsk, const Sbecore::ubigint jrefSup, const Sbecore::uint ixWzskVLocale);
	~CrdWzskLiv();
