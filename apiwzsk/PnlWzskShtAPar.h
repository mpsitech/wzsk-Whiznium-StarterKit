/**
	...
	* API code for job PnlWzskShtAPar (declarations)
...
namespace PnlWzskShtAPar {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWzskShtAPar::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzskShtAPar::StatApp statappqry;
