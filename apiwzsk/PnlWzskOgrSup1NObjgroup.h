/**
	...
	* API code for job PnlWzskOgrSup1NObjgroup (declarations)
...
/**
	...
	*/
namespace PnlWzskOgrSup1NObjgroup {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWzskOgrSup1NObjgroup::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzskOgrSup1NObjgroup::StatApp statappqry;
