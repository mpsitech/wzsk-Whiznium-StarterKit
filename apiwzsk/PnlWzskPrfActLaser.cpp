/**
	...
	* API code for job PnlWzskPrfActLaser (implementation)
...
bool PnlWzskPrfActLaser::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWzskPrfActLaser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWzskPrfActLaser";
...
bool PnlWzskPrfActLaser::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWzskPrfActLaser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWzskPrfActLaser";
...
PnlWzskPrfActLaser::DpchAppData::DpchAppData(
			...
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKPRFACTLASERDATA, scrJref)
		{
...
void PnlWzskPrfActLaser::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskPrfActLaserData");
...
PnlWzskPrfActLaser::DpchAppDo::DpchAppDo(
			...
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKPRFACTLASERDO, scrJref)
			, ixVDo(ixVDo)
		{
...
void PnlWzskPrfActLaser::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskPrfActLaserDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzsk");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWzskPrfActLaser::DpchEngData::DpchEngData() :
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKPRFACTLASERDATA)
		{
};
...
void PnlWzskPrfActLaser::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWzskPrfActLaserData");
	else
		basefound = checkXPath(docctx, basexpath);
