/**
	...
	* API code for job PnlWzskObjRef1NFile (declarations)
...
namespace PnlWzskObjRef1NFile {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWzskObjRef1NFile::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzskObjRef1NFile::StatApp statappqry;
