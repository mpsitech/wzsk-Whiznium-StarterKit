/**
	* \file CrdWzskPrs.cpp
	* API code for job CrdWzskPrs (implementation)
...
bool CrdWzskPrs::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWzskPrs");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWzskPrs";
...
bool CrdWzskPrs::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWzskPrs");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWzskPrs";
...
set<uint> CrdWzskPrs::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdWzskPrs::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdWzskPrs::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWzskPrs");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWzskPrs";
...
bool CrdWzskPrs::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWzskPrs");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWzskPrs";
...
CrdWzskPrs::DpchAppDo::DpchAppDo(
			...
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKPRSDO, scrJref)
		{
...
void CrdWzskPrs::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskPrsDo");
...
CrdWzskPrs::DpchEngData::DpchEngData() :
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKPRSDATA)
		{
...
void CrdWzskPrs::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWzskPrsData");
	else
		basefound = checkXPath(docctx, basexpath);
