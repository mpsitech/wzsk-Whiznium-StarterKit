/**
	...
	* API code for job PnlWzskObjList (declarations)
...
namespace PnlWzskObjList {
	...
	public:
		...
		static const Sbecore::uint TCOOGR = 8;

	public:
		Tag(const std::string& Cpt = "", const std::string& TxtRecord1 = "", const std::string& TxtRecord2 = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoTit = "", const std::string& TcoOgr = "");
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWzskObjList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzskObjList::StatApp statappqry;
