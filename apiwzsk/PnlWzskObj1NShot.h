/**
	...
	* API code for job PnlWzskObj1NShot (declarations)
...
namespace PnlWzskObj1NShot {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWzskObj1NShot::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzskObj1NShot::StatApp statappqry;
