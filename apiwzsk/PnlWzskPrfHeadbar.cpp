/**
	...
	* API code for job PnlWzskPrfHeadbar (implementation)
...
/******************************************************************************
 class PnlWzskPrfHeadbar::StgInf
 ******************************************************************************/

PnlWzskPrfHeadbar::StgInf::StgInf(
...
bool PnlWzskPrfHeadbar::StgInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgInfWzskPrfHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemInfWzskPrfHeadbar";
...
set<uint> PnlWzskPrfHeadbar::StgInf::comm(
			const StgInf* comp
		) {
	set<uint> items;
...
set<uint> PnlWzskPrfHeadbar::StgInf::diff(
			const StgInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlWzskPrfHeadbar::Tag
 ******************************************************************************/

PnlWzskPrfHeadbar::Tag::Tag(
			const string& MenApp
			, const string& MenCrd
		) :
			Block()
...
bool PnlWzskPrfHeadbar::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWzskPrfHeadbar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWzskPrfHeadbar";
...
/******************************************************************************
 class PnlWzskPrfHeadbar::DpchEngData
 ******************************************************************************/

PnlWzskPrfHeadbar::DpchEngData::DpchEngData() :
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKPRFHEADBARDATA)
		{
};

string PnlWzskPrfHeadbar::DpchEngData::getSrefsMask() {
	vector<string> ss;
	string srefs;
...
void PnlWzskPrfHeadbar::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWzskPrfHeadbarData");
	else
		basefound = checkXPath(docctx, basexpath);
