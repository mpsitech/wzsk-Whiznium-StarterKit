/**
	...
	* API code for job PnlWzskUsrMNUsergroup (declarations)
...
/**
	...
	*/
namespace PnlWzskUsrMNUsergroup {
	/**
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWzskUsrMNUsergroup::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzskUsrMNUsergroup::StatApp statappqry;
