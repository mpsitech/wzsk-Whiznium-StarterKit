/**
	...
	* API code for job DlgWzskScfTtablecoord (implementation)
...
bool DlgWzskScfTtablecoord::ContInf::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfDlgWzskScfTtablecoord");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfDlgWzskScfTtablecoord";
...
DlgWzskScfTtablecoord::StatApp::StatApp(
			const bool initdone
...
bool DlgWzskScfTtablecoord::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppDlgWzskScfTtablecoord");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppDlgWzskScfTtablecoord";
...
set<uint> DlgWzskScfTtablecoord::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> DlgWzskScfTtablecoord::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool DlgWzskScfTtablecoord::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrDlgWzskScfTtablecoord");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrDlgWzskScfTtablecoord";
...
bool DlgWzskScfTtablecoord::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagDlgWzskScfTtablecoord");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemDlgWzskScfTtablecoord";
...
DlgWzskScfTtablecoord::DpchAppData::DpchAppData(
			...
			DpchAppWzsk(VecWzskVDpch::DPCHAPPDLGWZSKSCFTTABLECOORDDATA, scrJref)
		{
...
void DlgWzskScfTtablecoord::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppDlgWzskScfTtablecoordData");
...
DlgWzskScfTtablecoord::DpchAppDo::DpchAppDo(
			...
			DpchAppWzsk(VecWzskVDpch::DPCHAPPDLGWZSKSCFTTABLECOORDDO, scrJref)
		{
...
void DlgWzskScfTtablecoord::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppDlgWzskScfTtablecoordDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzsk");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
DlgWzskScfTtablecoord::DpchEngData::DpchEngData() :
			DpchEngWzsk(VecWzskVDpch::DPCHENGDLGWZSKSCFTTABLECOORDDATA)
		{
...
void DlgWzskScfTtablecoord::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngDlgWzskScfTtablecoordData");
	else
		basefound = checkXPath(docctx, basexpath);
