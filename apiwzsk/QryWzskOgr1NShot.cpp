/**
	...
	* API code for job QryWzskOgr1NShot (implementation)
...
/******************************************************************************
 class QryWzskOgr1NShot::StatApp
 ******************************************************************************/

QryWzskOgr1NShot::StatApp::StatApp(
			const uint firstcol
...
bool QryWzskOgr1NShot::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryWzskOgr1NShot");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryWzskOgr1NShot";
...
set<uint> QryWzskOgr1NShot::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryWzskOgr1NShot::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWzskOgr1NShot::StatShr
 ******************************************************************************/

QryWzskOgr1NShot::StatShr::StatShr(
			const uint ntot
...
bool QryWzskOgr1NShot::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryWzskOgr1NShot");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryWzskOgr1NShot";
...
set<uint> QryWzskOgr1NShot::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryWzskOgr1NShot::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryWzskOgr1NShot::StgIac
 ******************************************************************************/

QryWzskOgr1NShot::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) :
...
bool QryWzskOgr1NShot::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryWzskOgr1NShot");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryWzskOgr1NShot";
...
void QryWzskOgr1NShot::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryWzskOgr1NShot";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryWzskOgr1NShot";
...
set<uint> QryWzskOgr1NShot::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryWzskOgr1NShot::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
