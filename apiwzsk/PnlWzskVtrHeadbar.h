/**
	* \file PnlWzskVtrHeadbar.h
	* API code for job PnlWzskVtrHeadbar (declarations)
...
#ifndef PNLWZSKVTRHEADBAR_H
#define PNLWZSKVTRHEADBAR_H

#include "ApiWzsk_blks.h"

#define StgInfWzskVtrHeadbar PnlWzskVtrHeadbar::StgInf
#define TagWzskVtrHeadbar PnlWzskVtrHeadbar::Tag

#define DpchEngWzskVtrHeadbarData PnlWzskVtrHeadbar::DpchEngData

/**
	* PnlWzskVtrHeadbar
	*/
namespace PnlWzskVtrHeadbar {
	/**
	  * StgInf (full: StgInfWzskVtrHeadbar)
	  */
	...
	/**
		* DpchEngData (full: DpchEngWzskVtrHeadbarData)
		*/
