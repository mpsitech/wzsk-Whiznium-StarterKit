/**
	* \file PnlWzskPrfHeadbar.h
	* API code for job PnlWzskPrfHeadbar (declarations)
...
#ifndef PNLWZSKPRFHEADBAR_H
#define PNLWZSKPRFHEADBAR_H

#include "ApiWzsk_blks.h"

#define StgInfWzskPrfHeadbar PnlWzskPrfHeadbar::StgInf
#define TagWzskPrfHeadbar PnlWzskPrfHeadbar::Tag

#define DpchEngWzskPrfHeadbarData PnlWzskPrfHeadbar::DpchEngData

/**
	* PnlWzskPrfHeadbar
	*/
namespace PnlWzskPrfHeadbar {
	/**
	  * StgInf (full: StgInfWzskPrfHeadbar)
	  */
	...
	/**
		* DpchEngData (full: DpchEngWzskPrfHeadbarData)
		*/
