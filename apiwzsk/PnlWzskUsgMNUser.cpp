...
bool PnlWzskUsgMNUser::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWzskUsgMNUser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWzskUsgMNUser";
...
PnlWzskUsgMNUser::StatApp::StatApp(
...
bool PnlWzskUsgMNUser::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWzskUsgMNUser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWzskUsgMNUser";
...
set<uint> PnlWzskUsgMNUser::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWzskUsgMNUser::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWzskUsgMNUser::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWzskUsgMNUser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWzskUsgMNUser";
...
bool PnlWzskUsgMNUser::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWzskUsgMNUser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWzskUsgMNUser";
...
PnlWzskUsgMNUser::DpchAppData::DpchAppData(
			...
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKUSGMNUSERDATA, scrJref)
		{
...
void PnlWzskUsgMNUser::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskUsgMNUserData");
...
PnlWzskUsgMNUser::DpchAppDo::DpchAppDo(
			...
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKUSGMNUSERDO, scrJref)
		{
...
void PnlWzskUsgMNUser::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskUsgMNUserDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzsk");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWzskUsgMNUser::DpchEngData::DpchEngData() :
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKUSGMNUSERDATA)
		{
...
void PnlWzskUsgMNUser::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWzskUsgMNUserData");
	else
		basefound = checkXPath(docctx, basexpath);
