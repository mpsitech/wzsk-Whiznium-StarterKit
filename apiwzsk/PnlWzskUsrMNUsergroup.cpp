...
bool PnlWzskUsrMNUsergroup::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWzskUsrMNUsergroup");
	else
...
PnlWzskUsrMNUsergroup::StatApp::StatApp(
...
bool PnlWzskUsrMNUsergroup::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWzskUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWzskUsrMNUsergroup::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWzskUsrMNUsergroup::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWzskUsrMNUsergroup::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWzskUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWzskUsrMNUsergroup::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWzskUsrMNUsergroup");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzskUsrMNUsergroup::DpchAppData::DpchAppData(
			...
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKUSRMNUSERGROUPDATA, scrJref)
		{
...
void PnlWzskUsrMNUsergroup::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskUsrMNUsergroupData");
...
void PnlWzskUsrMNUsergroup::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskUsrMNUsergroupDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzsk");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWzskUsrMNUsergroup::DpchEngData::DpchEngData() :
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKUSRMNUSERGROUPDATA)
		{
...
void PnlWzskUsrMNUsergroup::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWzskUsrMNUsergroupData");
	else
		basefound = checkXPath(docctx, basexpath);
