/**
	...
	* API code for job PnlWzskPrsADetail (declarations)
...
namespace PnlWzskPrsADetail {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWzskPrsADetail::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzskPrsADetail::StatApp statappqry;
