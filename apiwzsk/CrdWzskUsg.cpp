...
bool CrdWzskUsg::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWzskUsg");
	else
...
bool CrdWzskUsg::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWzskUsg");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> CrdWzskUsg::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdWzskUsg::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdWzskUsg::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWzskUsg");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool CrdWzskUsg::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWzskUsg");
	else
		basefound = checkXPath(docctx, basexpath);
...
void CrdWzskUsg::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskUsgDo");
...
CrdWzskUsg::DpchEngData::DpchEngData() :
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKUSGDATA)
		{
...
void CrdWzskUsg::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWzskUsgData");
	else
		basefound = checkXPath(docctx, basexpath);
