/**
	...
	* API code for job PnlWzskScfConn (implementation)
...
bool PnlWzskScfConn::StatShr::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWzskScfConn");
	else
...
bool PnlWzskScfConn::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWzskScfConn");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzskScfConn::DpchAppDo::DpchAppDo(
			...
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKSCFCONNDO, scrJref)
		{
...
void PnlWzskScfConn::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskScfConnDo");
...
PnlWzskScfConn::DpchEngData::DpchEngData() :
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKSCFCONNDATA)
		{
};
...
void PnlWzskScfConn::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWzskScfConnData");
	else
		basefound = checkXPath(docctx, basexpath);
