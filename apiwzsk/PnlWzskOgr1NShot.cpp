/**
	...
	* API code for job PnlWzskOgr1NShot (implementation)
...
bool PnlWzskOgr1NShot::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWzskOgr1NShot");
	else
...
PnlWzskOgr1NShot::StatApp::StatApp(
...
bool PnlWzskOgr1NShot::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWzskOgr1NShot");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWzskOgr1NShot::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWzskOgr1NShot::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWzskOgr1NShot::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWzskOgr1NShot");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWzskOgr1NShot::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWzskOgr1NShot");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzskOgr1NShot::DpchAppData::DpchAppData(
			...
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKOGR1NSHOTDATA, scrJref)
		{
...
void PnlWzskOgr1NShot::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskOgr1NShotData");
...
PnlWzskOgr1NShot::DpchAppDo::DpchAppDo(
			...
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKOGR1NSHOTDO, scrJref)
		{
...
void PnlWzskOgr1NShot::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskOgr1NShotDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzsk");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWzskOgr1NShot::DpchEngData::DpchEngData() :
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKOGR1NSHOTDATA)
		{
...
void PnlWzskOgr1NShot::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWzskOgr1NShotData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryWzskOgr1NShot::StatApp();
		statshrqry = QryWzskOgr1NShot::StatShr();
