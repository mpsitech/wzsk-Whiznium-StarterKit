...
bool PnlWzskUsr1NSession::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWzskUsr1NSession");
	else
...
PnlWzskUsr1NSession::StatApp::StatApp(
...
bool PnlWzskUsr1NSession::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWzskUsr1NSession");
	else
		basefound = checkXPath(docctx, basexpath);
...
set<uint> PnlWzskUsr1NSession::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWzskUsr1NSession::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWzskUsr1NSession::StatShr::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWzskUsr1NSession");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWzskUsr1NSession::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWzskUsr1NSession");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzskUsr1NSession::DpchAppData::DpchAppData(
			...
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKUSR1NSESSIONDATA, scrJref)
		{
...
void PnlWzskUsr1NSession::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskUsr1NSessionData");
...
void PnlWzskUsr1NSession::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskUsr1NSessionDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzsk");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWzskUsr1NSession::DpchEngData::DpchEngData() :
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKUSR1NSESSIONDATA)
		{
...
void PnlWzskUsr1NSession::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWzskUsr1NSessionData");
	else
		basefound = checkXPath(docctx, basexpath);
