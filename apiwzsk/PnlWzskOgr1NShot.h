/**
	...
	* API code for job PnlWzskOgr1NShot (declarations)
...
namespace PnlWzskOgr1NShot {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWzskOgr1NShot::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzskOgr1NShot::StatApp statappqry;
