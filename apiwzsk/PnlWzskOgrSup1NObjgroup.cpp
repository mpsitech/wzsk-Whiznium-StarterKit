/**
	...
	* API code for job PnlWzskOgrSup1NObjgroup (implementation)
...
bool PnlWzskOgrSup1NObjgroup::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWzskOgrSup1NObjgroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfWzskOgrSup1NObjgroup";
...
PnlWzskOgrSup1NObjgroup::StatApp::StatApp(
...
bool PnlWzskOgrSup1NObjgroup::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppWzskOgrSup1NObjgroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppWzskOgrSup1NObjgroup";
...
set<uint> PnlWzskOgrSup1NObjgroup::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlWzskOgrSup1NObjgroup::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlWzskOgrSup1NObjgroup::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWzskOgrSup1NObjgroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrWzskOgrSup1NObjgroup";
...
PnlWzskOgrSup1NObjgroup::Tag::Tag(
			const string& Cpt
...
bool PnlWzskOgrSup1NObjgroup::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWzskOgrSup1NObjgroup");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemWzskOgrSup1NObjgroup";
...
PnlWzskOgrSup1NObjgroup::DpchAppData::DpchAppData(
			...
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKOGRSUP1NOBJGROUPDATA, scrJref)
		{
...
void PnlWzskOgrSup1NObjgroup::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskOgrSup1NObjgroupData");
...
PnlWzskOgrSup1NObjgroup::DpchAppDo::DpchAppDo(
			...
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKOGRSUP1NOBJGROUPDO, scrJref)
		{
...
void PnlWzskOgrSup1NObjgroup::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskOgrSup1NObjgroupDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzsk");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWzskOgrSup1NObjgroup::DpchEngData::DpchEngData() :
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKOGRSUP1NOBJGROUPDATA)
		{
...
void PnlWzskOgrSup1NObjgroup::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWzskOgrSup1NObjgroupData");
	else
		basefound = checkXPath(docctx, basexpath);
