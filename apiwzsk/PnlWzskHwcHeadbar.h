/**
	* \file PnlWzskHwcHeadbar.h
	* API code for job PnlWzskHwcHeadbar (declarations)
...
#ifndef PNLWZSKHWCHEADBAR_H
#define PNLWZSKHWCHEADBAR_H

#include "ApiWzsk_blks.h"

#define StgInfWzskHwcHeadbar PnlWzskHwcHeadbar::StgInf
#define TagWzskHwcHeadbar PnlWzskHwcHeadbar::Tag

#define DpchEngWzskHwcHeadbarData PnlWzskHwcHeadbar::DpchEngData

/**
	* PnlWzskHwcHeadbar
	*/
namespace PnlWzskHwcHeadbar {
	/**
	  * StgInf (full: StgInfWzskHwcHeadbar)
	  */
	...
	/**
		* DpchEngData (full: DpchEngWzskHwcHeadbarData)
		*/
