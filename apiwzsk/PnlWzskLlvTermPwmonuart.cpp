/**
	...
	* API code for job PnlWzskLlvTermPwmonuart (implementation)
...
bool PnlWzskLlvTermPwmonuart::ContInf::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfWzskLlvTermPwmonuart");
	else
		basefound = checkXPath(docctx, basexpath);
...
bool PnlWzskLlvTermPwmonuart::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrWzskLlvTermPwmonuart");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzskLlvTermPwmonuart::Tag::Tag(
			const string& Cpt
			, const string& CptCst
			, const string& HdgDio
			, const string& HdgCex
...
bool PnlWzskLlvTermPwmonuart::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagWzskLlvTermPwmonuart");
	else
		basefound = checkXPath(docctx, basexpath);
...
PnlWzskLlvTermPwmonuart::DpchAppData::DpchAppData(
			...
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKLLVTERMPWMONUARTDATA, scrJref)
		{
...
void PnlWzskLlvTermPwmonuart::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskLlvTermPwmonuartData");
...
PnlWzskLlvTermPwmonuart::DpchAppDo::DpchAppDo(
			...
			DpchAppWzsk(VecWzskVDpch::DPCHAPPWZSKLLVTERMPWMONUARTDO, scrJref)
		{
...
void PnlWzskLlvTermPwmonuart::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppWzskLlvTermPwmonuartDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.mpsitech.com/wzsk");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlWzskLlvTermPwmonuart::DpchEngData::DpchEngData() :
			DpchEngWzsk(VecWzskVDpch::DPCHENGWZSKLLVTERMPWMONUARTDATA)
		{
...
void PnlWzskLlvTermPwmonuart::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngWzskLlvTermPwmonuartData");
	else
		basefound = checkXPath(docctx, basexpath);
