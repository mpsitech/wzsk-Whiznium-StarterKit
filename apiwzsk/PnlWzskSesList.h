/**
	...
	* API code for job PnlWzskSesList (declarations)
...
namespace PnlWzskSesList {
	...
	public:
		StgIac(const Sbecore::uint TcoUsrWidth = 100, const Sbecore::uint TcoStaWidth = 100, const Sbecore::uint TcoStoWidth = 100, const Sbecore::uint TcoIpWidth = 100);
	...
	public:
		...
		static const Sbecore::uint TCOUSR = 7;
		static const Sbecore::uint TCOSTA = 8;
		static const Sbecore::uint TCOSTO = 9;
		static const Sbecore::uint TCOIP = 10;

	public:
		Tag(const std::string& Cpt = "", const std::string& TxtRecord1 = "", const std::string& TxtRecord2 = "", const std::string& Trs = "", const std::string& TxtShowing1 = "", const std::string& TxtShowing2 = "", const std::string& TcoUsr = "", const std::string& TcoSta = "", const std::string& TcoSto = "", const std::string& TcoIp = "");
	...
	public:
		DpchAppData(const std::string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryWzskSesList::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzskSesList::StatApp statappqry;
