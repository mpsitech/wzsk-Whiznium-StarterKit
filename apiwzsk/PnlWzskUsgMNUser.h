/**
	...
	* API code for job PnlWzskUsgMNUser (declarations)
...
namespace PnlWzskUsgMNUser {
	...
	public:
		DpchAppData(const std::string& scrJref = "", StgIac* stgiac = NULL, QryWzskUsgMNUser::StgIac* stgiacqry = NULL, const std::set<Sbecore::uint>& mask = {NONE});
	...
	public:
		...
		QryWzskUsgMNUser::StatApp statappqry;
