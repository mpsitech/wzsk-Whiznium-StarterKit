...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWzskPrsList.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWzskPrsListData": {
						"scrJref": this.scrJref,
						"StgIacQryWzskPrsList": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWzskPrsList"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWzskPrsListData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWzskPrsListData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContIacWzskPrsList) this.contiac = dpcheng.ContIacWzskPrsList;
				if (dpcheng.ContInfWzskPrsList) this.continf = dpcheng.ContInfWzskPrsList;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.FeedFTos) this.feedFTos = dpcheng.FeedFTos;
				if (dpcheng.StatShrWzskPrsList) this.statshr = dpcheng.StatShrWzskPrsList;
				if (dpcheng.StgIacWzskPrsList) this.stgiac = dpcheng.StgIacWzskPrsList;
				if (dpcheng.TagWzskPrsList) {
					Wzsk.unescapeBlock(dpcheng.TagWzskPrsList);
					this.tag = dpcheng.TagWzskPrsList;
				}
				if (dpcheng.ListWzskQPrsList) this.rst = dpcheng.ListWzskQPrsList;
				if (dpcheng.StatAppQryWzskPrsList) this.statappqry = dpcheng.StatAppQryWzskPrsList;
				if (dpcheng.StatShrQryWzskPrsList) this.statshrqry = dpcheng.StatShrQryWzskPrsList;
				if (dpcheng.StgIacQryWzskPrsList) this.stgiacqry = dpcheng.StgIacQryWzskPrsList;
				if (dpcheng.ContInfWzskPrsList) {
			...
			handleDpchAppDataDoReply: function(srefIxWzskVDpch, dpcheng) {
				if (srefIxWzskVDpch == "DpchEngWzskPrsListData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWzskVDpch == "DpchEngWzskPrsListData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
