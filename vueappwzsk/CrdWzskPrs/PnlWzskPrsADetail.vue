...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWzskPrsADetail.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWzskPrsADetailData": {
						"scrJref": this.scrJref,
						"StgIacQryWzskPrsADetail": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWzskPrsADetail"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWzskPrsADetailData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWzskPrsADetailData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWzskPrsADetail) this.continf = dpcheng.ContInfWzskPrsADetail;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWzskPrsADetail) this.statapp = dpcheng.StatAppWzskPrsADetail;
				if (dpcheng.StatShrWzskPrsADetail) this.statshr = dpcheng.StatShrWzskPrsADetail;
				if (dpcheng.StgIacWzskPrsADetail) this.stgiac = dpcheng.StgIacWzskPrsADetail;
				if (dpcheng.TagWzskPrsADetail) {
					Wzsk.unescapeBlock(dpcheng.TagWzskPrsADetail);
					this.tag = dpcheng.TagWzskPrsADetail;
				}
				if (dpcheng.ListWzskQPrsADetail) this.rst = dpcheng.ListWzskQPrsADetail;
				if (dpcheng.StatAppQryWzskPrsADetail) this.statappqry = dpcheng.StatAppQryWzskPrsADetail;
				if (dpcheng.StatShrQryWzskPrsADetail) this.statshrqry = dpcheng.StatShrQryWzskPrsADetail;
				if (dpcheng.StgIacQryWzskPrsADetail) this.stgiacqry = dpcheng.StgIacQryWzskPrsADetail;
				/*
				...
				*/
				...
				if (dpcheng.ListWzskQPrsADetail) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWzskVDpch, dpcheng) {
				if (srefIxWzskVDpch == "DpchEngWzskPrsADetailData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWzskVDpch == "DpchEngWzskPrsADetailData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
