...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWzskOgr1NObject.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWzskOgr1NObjectData": {
						"scrJref": this.scrJref,
						"StgIacQryWzskOgr1NObject": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWzskOgr1NObject"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWzskOgr1NObjectData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWzskOgr1NObjectData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWzskOgr1NObject) this.continf = dpcheng.ContInfWzskOgr1NObject;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWzskOgr1NObject) this.statapp = dpcheng.StatAppWzskOgr1NObject;
				if (dpcheng.StatShrWzskOgr1NObject) this.statshr = dpcheng.StatShrWzskOgr1NObject;
				if (dpcheng.StgIacWzskOgr1NObject) this.stgiac = dpcheng.StgIacWzskOgr1NObject;
				if (dpcheng.TagWzskOgr1NObject) {
					Wzsk.unescapeBlock(dpcheng.TagWzskOgr1NObject);
					this.tag = dpcheng.TagWzskOgr1NObject;
				}
				if (dpcheng.ListWzskQOgr1NObject) this.rst = dpcheng.ListWzskQOgr1NObject;
				if (dpcheng.StatAppQryWzskOgr1NObject) this.statappqry = dpcheng.StatAppQryWzskOgr1NObject;
				if (dpcheng.StatShrQryWzskOgr1NObject) this.statshrqry = dpcheng.StatShrQryWzskOgr1NObject;
				if (dpcheng.StgIacQryWzskOgr1NObject) this.stgiacqry = dpcheng.StgIacQryWzskOgr1NObject;
				/*
				...
				*/
				...
				if (dpcheng.ListWzskQOgr1NObject) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWzskVDpch, dpcheng) {
				if (srefIxWzskVDpch == "DpchEngWzskOgr1NObjectData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWzskVDpch == "DpchEngWzskOgr1NObjectData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
