...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWzskUsrAAccess.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWzskUsrAAccessData": {
						"scrJref": this.scrJref,
						"StgIacQryWzskUsrAAccess": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWzskUsrAAccess"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWzskUsrAAccessData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWzskUsrAAccessData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWzskUsrAAccess) this.continf = dpcheng.ContInfWzskUsrAAccess;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWzskUsrAAccess) this.statapp = dpcheng.StatAppWzskUsrAAccess;
				if (dpcheng.StatShrWzskUsrAAccess) this.statshr = dpcheng.StatShrWzskUsrAAccess;
				if (dpcheng.StgIacWzskUsrAAccess) this.stgiac = dpcheng.StgIacWzskUsrAAccess;
				if (dpcheng.TagWzskUsrAAccess) {
					Wzsk.unescapeBlock(dpcheng.TagWzskUsrAAccess);
					this.tag = dpcheng.TagWzskUsrAAccess;
				}
				if (dpcheng.ListWzskQUsrAAccess) this.rst = dpcheng.ListWzskQUsrAAccess;
				if (dpcheng.StatAppQryWzskUsrAAccess) this.statappqry = dpcheng.StatAppQryWzskUsrAAccess;
				if (dpcheng.StatShrQryWzskUsrAAccess) this.statshrqry = dpcheng.StatShrQryWzskUsrAAccess;
				if (dpcheng.StgIacQryWzskUsrAAccess) this.stgiacqry = dpcheng.StgIacQryWzskUsrAAccess;
				/*
				...
				*/
				...
				if (dpcheng.ListWzskQUsrAAccess) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWzskVDpch, dpcheng) {
				if (srefIxWzskVDpch == "DpchEngWzskUsrAAccessData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWzskVDpch == "DpchEngWzskUsrAAccessData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
