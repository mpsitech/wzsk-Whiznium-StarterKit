...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWzskShtRef1NFile.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWzskShtRef1NFileData": {
						"scrJref": this.scrJref,
						"StgIacQryWzskShtRef1NFile": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWzskShtRef1NFile"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWzskShtRef1NFileData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWzskShtRef1NFileData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWzskShtRef1NFile) this.continf = dpcheng.ContInfWzskShtRef1NFile;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWzskShtRef1NFile) this.statapp = dpcheng.StatAppWzskShtRef1NFile;
				if (dpcheng.StatShrWzskShtRef1NFile) this.statshr = dpcheng.StatShrWzskShtRef1NFile;
				if (dpcheng.StgIacWzskShtRef1NFile) this.stgiac = dpcheng.StgIacWzskShtRef1NFile;
				if (dpcheng.TagWzskShtRef1NFile) {
					Wzsk.unescapeBlock(dpcheng.TagWzskShtRef1NFile);
					this.tag = dpcheng.TagWzskShtRef1NFile;
				}
				if (dpcheng.ListWzskQShtRef1NFile) this.rst = dpcheng.ListWzskQShtRef1NFile;
				if (dpcheng.StatAppQryWzskShtRef1NFile) this.statappqry = dpcheng.StatAppQryWzskShtRef1NFile;
				if (dpcheng.StatShrQryWzskShtRef1NFile) this.statshrqry = dpcheng.StatShrQryWzskShtRef1NFile;
				if (dpcheng.StgIacQryWzskShtRef1NFile) this.stgiacqry = dpcheng.StgIacQryWzskShtRef1NFile;
				/*
				...
				*/
				...
				if (dpcheng.ListWzskQShtRef1NFile) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWzskVDpch, dpcheng) {
				if (srefIxWzskVDpch == "DpchEngWzskShtRef1NFileData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWzskVDpch == "DpchEngWzskShtRef1NFileData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
