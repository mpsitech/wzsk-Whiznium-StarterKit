...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWzskShtAPar.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWzskShtAParData": {
						"scrJref": this.scrJref,
						"StgIacQryWzskShtAPar": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWzskShtAPar"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWzskShtAParData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWzskShtAParData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWzskShtAPar) this.continf = dpcheng.ContInfWzskShtAPar;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWzskShtAPar) this.statapp = dpcheng.StatAppWzskShtAPar;
				if (dpcheng.StatShrWzskShtAPar) this.statshr = dpcheng.StatShrWzskShtAPar;
				if (dpcheng.StgIacWzskShtAPar) this.stgiac = dpcheng.StgIacWzskShtAPar;
				if (dpcheng.TagWzskShtAPar) {
					Wzsk.unescapeBlock(dpcheng.TagWzskShtAPar);
					this.tag = dpcheng.TagWzskShtAPar;
				}
				if (dpcheng.ListWzskQShtAPar) this.rst = dpcheng.ListWzskQShtAPar;
				if (dpcheng.StatAppQryWzskShtAPar) this.statappqry = dpcheng.StatAppQryWzskShtAPar;
				if (dpcheng.StatShrQryWzskShtAPar) this.statshrqry = dpcheng.StatShrQryWzskShtAPar;
				if (dpcheng.StgIacQryWzskShtAPar) this.stgiacqry = dpcheng.StgIacQryWzskShtAPar;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWzskVDpch, dpcheng) {
				if (srefIxWzskVDpch == "DpchEngWzskShtAParData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWzskVDpch == "DpchEngWzskShtAParData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
