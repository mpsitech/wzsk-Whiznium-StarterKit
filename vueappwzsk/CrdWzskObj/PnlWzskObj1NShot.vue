...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWzskObj1NShot.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWzskObj1NShotData": {
						"scrJref": this.scrJref,
						"StgIacQryWzskObj1NShot": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWzskObj1NShot"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWzskObj1NShotData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWzskObj1NShotData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWzskObj1NShot) this.continf = dpcheng.ContInfWzskObj1NShot;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWzskObj1NShot) this.statapp = dpcheng.StatAppWzskObj1NShot;
				if (dpcheng.StatShrWzskObj1NShot) this.statshr = dpcheng.StatShrWzskObj1NShot;
				if (dpcheng.StgIacWzskObj1NShot) this.stgiac = dpcheng.StgIacWzskObj1NShot;
				if (dpcheng.TagWzskObj1NShot) {
					Wzsk.unescapeBlock(dpcheng.TagWzskObj1NShot);
					this.tag = dpcheng.TagWzskObj1NShot;
				}
				if (dpcheng.ListWzskQObj1NShot) this.rst = dpcheng.ListWzskQObj1NShot;
				if (dpcheng.StatAppQryWzskObj1NShot) this.statappqry = dpcheng.StatAppQryWzskObj1NShot;
				if (dpcheng.StatShrQryWzskObj1NShot) this.statshrqry = dpcheng.StatShrQryWzskObj1NShot;
				if (dpcheng.StgIacQryWzskObj1NShot) this.stgiacqry = dpcheng.StgIacQryWzskObj1NShot;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWzskVDpch, dpcheng) {
				if (srefIxWzskVDpch == "DpchEngWzskObj1NShotData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWzskVDpch == "DpchEngWzskObj1NShotData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
