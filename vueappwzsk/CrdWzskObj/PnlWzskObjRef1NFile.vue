...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWzskObjRef1NFile.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWzskObjRef1NFileData": {
						"scrJref": this.scrJref,
						"StgIacQryWzskObjRef1NFile": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWzskObjRef1NFile"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWzskObjRef1NFileData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWzskObjRef1NFileData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWzskObjRef1NFile) this.continf = dpcheng.ContInfWzskObjRef1NFile;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWzskObjRef1NFile) this.statapp = dpcheng.StatAppWzskObjRef1NFile;
				if (dpcheng.StatShrWzskObjRef1NFile) this.statshr = dpcheng.StatShrWzskObjRef1NFile;
				if (dpcheng.StgIacWzskObjRef1NFile) this.stgiac = dpcheng.StgIacWzskObjRef1NFile;
				if (dpcheng.TagWzskObjRef1NFile) {
					Wzsk.unescapeBlock(dpcheng.TagWzskObjRef1NFile);
					this.tag = dpcheng.TagWzskObjRef1NFile;
				}
				if (dpcheng.ListWzskQObjRef1NFile) this.rst = dpcheng.ListWzskQObjRef1NFile;
				if (dpcheng.StatAppQryWzskObjRef1NFile) this.statappqry = dpcheng.StatAppQryWzskObjRef1NFile;
				if (dpcheng.StatShrQryWzskObjRef1NFile) this.statshrqry = dpcheng.StatShrQryWzskObjRef1NFile;
				if (dpcheng.StgIacQryWzskObjRef1NFile) this.stgiacqry = dpcheng.StgIacQryWzskObjRef1NFile;
				/*
				...
				*/
				...
				if (dpcheng.ListWzskQObjRef1NFile) {
					var rows = [];
			...
			handleDpchAppDataDoReply: function(srefIxWzskVDpch, dpcheng) {
				if (srefIxWzskVDpch == "DpchEngWzskObjRef1NFileData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWzskVDpch == "DpchEngWzskObjRef1NFileData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
