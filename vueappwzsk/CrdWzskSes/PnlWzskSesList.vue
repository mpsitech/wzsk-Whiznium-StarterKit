		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWzskSesListData": {
						"scrJref": this.scrJref,
						"StgIacQryWzskSesList": stgiacqry
					}
				};
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				...
				if (dpcheng.TagWzskSesList) {
					...
					/*
					*/
					tcos.push({value: "jnum", text: "jnum"}, {value: "TcoUsr", text: this.tag.TcoUsr}, {value: "TcoSta", text: this.tag.TcoSta}, {value: "TcoSto", text: this.tag.TcoSto}, {value: "TcoIp", text: this.tag.TcoIp});
					/*
					*/
				...
				if (dpcheng.ListWzskQSesList) {
					...
					for (var i = 0; i < this.rst.length; i++) {
						...
						/*
						*/
						rows.push({jnum: rec["jnum"], TcoUsr: rec["usr"], TcoSta: rec["sta"], TcoSto: rec["sto"], TcoIp: rec["ip"]})
						/*
						*/
