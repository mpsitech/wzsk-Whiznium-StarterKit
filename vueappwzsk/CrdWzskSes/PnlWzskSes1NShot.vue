...
<script>
	...
	*/
	...
	export default {
		...
		mounted() {
			//console.log("PnlWzskSes1NShot.mounted() with scrJref = " + this.scrJref);
		...
		methods: {
			...
			*/
			...
			handleSelect: function(obj) {
				...
				const dpchapp = {
					"DpchAppWzskSes1NShotData": {
						"scrJref": this.scrJref,
						"StgIacQryWzskSes1NShot": stgiacqry
					}
				};
			...
			updateEng: function(mask) {
				...
				if (mask.indexOf("contiac") != -1) dpchapp["ContIacWzskSes1NShot"] = this.contiac;

				//console.log(JSON.stringify({"DpchAppWzskSes1NShotData": dpchapp}))

				this.$emit("request", {scrJref: this.scrJref, dpchapp: {"DpchAppWzskSes1NShotData": dpchapp}, then: "handleDpchAppDataDoReply"});
			},
			...
			mergeDpchEngData: function(dpcheng) {
				...
				*/
				if (dpcheng.ContInfWzskSes1NShot) this.continf = dpcheng.ContInfWzskSes1NShot;
				if (dpcheng.FeedFCsiQst) this.feedFCsiQst = dpcheng.FeedFCsiQst;
				if (dpcheng.StatAppWzskSes1NShot) this.statapp = dpcheng.StatAppWzskSes1NShot;
				if (dpcheng.StatShrWzskSes1NShot) this.statshr = dpcheng.StatShrWzskSes1NShot;
				if (dpcheng.StgIacWzskSes1NShot) this.stgiac = dpcheng.StgIacWzskSes1NShot;
				if (dpcheng.TagWzskSes1NShot) {
					Wzsk.unescapeBlock(dpcheng.TagWzskSes1NShot);
					this.tag = dpcheng.TagWzskSes1NShot;
				}
				if (dpcheng.ListWzskQSes1NShot) this.rst = dpcheng.ListWzskQSes1NShot;
				if (dpcheng.StatAppQryWzskSes1NShot) this.statappqry = dpcheng.StatAppQryWzskSes1NShot;
				if (dpcheng.StatShrQryWzskSes1NShot) this.statshrqry = dpcheng.StatShrQryWzskSes1NShot;
				if (dpcheng.StgIacQryWzskSes1NShot) this.stgiacqry = dpcheng.StgIacQryWzskSes1NShot;
				/*
			...
			handleDpchAppDataDoReply: function(srefIxWzskVDpch, dpcheng) {
				if (srefIxWzskVDpch == "DpchEngWzskSes1NShotData") this.mergeDpchEngData(dpcheng);
			},
			...
			*/
			...
			handleUpdate: function(obj) {
				/*
				*/
				if (obj.srefIxWzskVDpch == "DpchEngWzskSes1NShotData") this.mergeDpchEngData(obj.dpcheng);
				/*
				*/
			}
		},
