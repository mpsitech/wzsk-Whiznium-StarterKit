/**
  * \file PnlWzskObjRef1NFile.swift
  * Swift API code for job PnlWzskObjRef1NFile
...
public class PnlWzskObjRef1NFile {
	...
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskObjRef1NFile")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskObjRef1NFile"
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppWzskObjRef1NFile")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppWzskObjRef1NFile"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskObjRef1NFile")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskObjRef1NFile"
	...
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacWzskObjRef1NFile")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacWzskObjRef1NFile"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacWzskObjRef1NFile"}

			let itemtag: String = shorttags ? "Si" : "StgitemacWzskObjRef1NFile"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskObjRef1NFile")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskObjRef1NFile"
	...
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
					_ scrJref: String = ""
					, _ stgiac: StgIac? = nil
					, _ stgiacqry: QryWzskObjRef1NFile.StgIac? = nil
					, mask: Set<Int> = []
				) {
			super.init(VecWzskVDpch.DPCHAPPWZSKOBJREF1NFILEDATA, scrJref)
		...
		public var stgiacqry: QryWzskObjRef1NFile.StgIac = QryWzskObjRef1NFile.StgIac()
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskObjRef1NFileData")
	...
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKOBJREF1NFILEDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskObjRef1NFileDo")
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKOBJREF1NFILEDATA)
		}
		...
		public var rst: ListWzskQObjRef1NFile = ListWzskQObjRef1NFile()
		public var statappqry: QryWzskObjRef1NFile.StatApp = QryWzskObjRef1NFile.StatApp()
		public var statshrqry: QryWzskObjRef1NFile.StatShr = QryWzskObjRef1NFile.StatShr()
		public var stgiacqry: QryWzskObjRef1NFile.StgIac = QryWzskObjRef1NFile.StgIac()
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskObjRef1NFileData")}
			valid = basexpath != nil
