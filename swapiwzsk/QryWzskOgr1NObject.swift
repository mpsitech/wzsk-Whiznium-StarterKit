/**
  * \file QryWzskOgr1NObject.swift
  * Swift API code for job QryWzskOgr1NObject
...
/**
	* QryWzskOgr1NObject
	*/
public class QryWzskOgr1NObject {
	/**
	  * StatApp (full: StatAppQryWzskOgr1NObject)
	  */
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskOgr1NObject")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskOgr1NObject"
	...
	/**
	  * StatShr (full: StatShrQryWzskOgr1NObject)
	  */
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskOgr1NObject")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskOgr1NObject"
	...
	/**
	  * StgIac (full: StgIacQryWzskOgr1NObject)
	  */
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskOgr1NObject")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskOgr1NObject"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskOgr1NObject"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskOgr1NObject"
