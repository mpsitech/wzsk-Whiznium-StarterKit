...
/**
	* VecWzskVDpch
	*/
public struct VecWzskVDpch {

	public static let DPCHENGDLGWZSKFILDOWNLOADDATA: Int = 1
	public static let DPCHENGDLGWZSKNAVLOAINIDATA: Int = 2
	public static let DPCHENGDLGWZSKOBJNEWDATA: Int = 3
	public static let DPCHENGDLGWZSKOGRNEWDATA: Int = 4
	public static let DPCHENGDLGWZSKSCFCAMERAMATDATA: Int = 5
	public static let DPCHENGDLGWZSKSCFLASERPOSDATA: Int = 6
	public static let DPCHENGDLGWZSKSCFTTABLECOORDDATA: Int = 7
	public static let DPCHENGM2MSESSWZSKDATA: Int = 8
	public static let DPCHENGROOTWZSKDATA: Int = 9
	public static let DPCHENGSESSWZSKDATA: Int = 10
	public static let DPCHENGWZSKACK: Int = 11
	public static let DPCHENGWZSKALERT: Int = 12
	public static let DPCHENGWZSKCONFIRM: Int = 13
	public static let DPCHENGWZSKFILDATA: Int = 14
	public static let DPCHENGWZSKFILDETAILDATA: Int = 15
	public static let DPCHENGWZSKFILHEADBARDATA: Int = 16
	public static let DPCHENGWZSKFILLISTDATA: Int = 17
	public static let DPCHENGWZSKFILRECDATA: Int = 18
	public static let DPCHENGWZSKLIV2DVIEWALIGN: Int = 19
	public static let DPCHENGWZSKLIV2DVIEWDATA: Int = 20
	public static let DPCHENGWZSKLIV2DVIEWLIVE: Int = 21
	public static let DPCHENGWZSKLIV3DVIEWDATA: Int = 22
	public static let DPCHENGWZSKLIV3DVIEWLIVE: Int = 23
	public static let DPCHENGWZSKLIVDATA: Int = 24
	public static let DPCHENGWZSKLIVHEADBARDATA: Int = 25
	public static let DPCHENGWZSKLIVSYSMONDATA: Int = 26
	public static let DPCHENGWZSKLIVSYSMONLIVE: Int = 27
	public static let DPCHENGWZSKLLVCAMERADATA: Int = 28
	public static let DPCHENGWZSKLLVCAMERALIVE: Int = 29
	public static let DPCHENGWZSKLLVDATA: Int = 30
	public static let DPCHENGWZSKLLVHEADBARDATA: Int = 31
	public static let DPCHENGWZSKLLVLASERDATA: Int = 32
	public static let DPCHENGWZSKLLVTERMARTYDATA: Int = 33
