/**
  * \file PnlWzskLlvTermUvbdvk.swift
  * Swift API code for job PnlWzskLlvTermUvbdvk
...
/**
	...
	*/
public class PnlWzskLlvTermUvbdvk {
	/**
		* VecVDo (full: VecVWzskLlvTermUvbdvkDo)
		*/
	public class VecVDo {
	...
	/**
	  * ContIac (full: ContIacWzskLlvTermUvbdvk)
	  */
	public class ContIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContIacWzskLlvTermUvbdvk")}
			valid = basexpath != nil

			let itemtag: String = "ContitemIacWzskLlvTermUvbdvk"
		...
		public func writeXML(
			...
			if tag == nil {tag = "ContIacWzskLlvTermUvbdvk"}

			let itemtag: String = shorttags ? "Ci" : "ContitemIacWzskLlvTermUvbdvk"
	...
	/**
	  * ContInf (full: ContInfWzskLlvTermUvbdvk)
	  */
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskLlvTermUvbdvk")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskLlvTermUvbdvk"
	...
	/**
	  * StatShr (full: StatShrWzskLlvTermUvbdvk)
	  */
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskLlvTermUvbdvk")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskLlvTermUvbdvk"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskLlvTermUvbdvk")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskLlvTermUvbdvk"
	...
	/**
		* DpchAppData (full: DpchAppWzskLlvTermUvbdvkData)
		*/
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKLLVTERMUVBDVKDATA, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskLlvTermUvbdvkData")
	...
	/**
		* DpchAppDo (full: DpchAppWzskLlvTermUvbdvkDo)
		*/
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKLLVTERMUVBDVKDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskLlvTermUvbdvkDo")
	...
	/**
		* DpchEngData (full: DpchEngWzskLlvTermUvbdvkData)
		*/
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKLLVTERMUVBDVKDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskLlvTermUvbdvkData")}
			valid = basexpath != nil
