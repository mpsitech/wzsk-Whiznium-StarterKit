/**
  * \file PnlWzskFilHeadbar.swift
  * Swift API code for job PnlWzskFilHeadbar
...
/**
	* PnlWzskFilHeadbar
	*/
public class PnlWzskFilHeadbar {
	/**
	...
	public class StgInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgInfWzskFilHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "StgitemnfWzskFilHeadbar"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskFilHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskFilHeadbar"
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKFILHEADBARDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskFilHeadbarData")}
			valid = basexpath != nil
