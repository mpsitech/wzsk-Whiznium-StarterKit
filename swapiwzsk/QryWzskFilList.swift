/**
  * \file QryWzskFilList.swift
  * Swift API code for job QryWzskFilList
...
/**
	* QryWzskFilList
	*/
public class QryWzskFilList {
	/**
		* VecVOrd (full: VecVQryWzskFilListOrd)
		*/
	public class VecVOrd {

		public static let RET: Int = 1
		public static let REU: Int = 2
		public static let FNM: Int = 3
		public static let OWN: Int = 4
		public static let GRP: Int = 5
	...
	/**
	  * StatApp (full: StatAppQryWzskFilList)
	  */
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskFilList")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskFilList"
	...
	/**
	  * StatShr (full: StatShrQryWzskFilList)
	  */
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskFilList")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskFilList"
	...
	/**
	  * StgIac (full: StgIacQryWzskFilList)
	  */
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskFilList")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskFilList"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskFilList"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskFilList"
