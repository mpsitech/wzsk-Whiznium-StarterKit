/**
  * \file QryWzskUsrAAccess.swift
  * Swift API code for job QryWzskUsrAAccess
...
/**
	* QryWzskUsrAAccess
	*/
public class QryWzskUsrAAccess {
	/**
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskUsrAAccess")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskUsrAAccess"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskUsrAAccess")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskUsrAAccess"
	...
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskUsrAAccess")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskUsrAAccess"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskUsrAAccess"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskUsrAAccess"
