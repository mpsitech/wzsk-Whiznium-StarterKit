/**
  * \file QryWzskUsgList.swift
  * Swift API code for job QryWzskUsgList
...
public class QryWzskUsgList {
	...
	public class VecVOrd {
		...
		public static let OWN: Int = 1
		public static let SRF: Int = 2
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskUsgList")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskUsgList"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskUsgList")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskUsgList"
	...
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskUsgList")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskUsgList"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskUsgList"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskUsgList"
