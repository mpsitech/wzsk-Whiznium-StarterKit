/**
  * \file PnlWzskPrsList.swift
  * Swift API code for job PnlWzskPrsList
...
public class PnlWzskPrsList {
	...
	public class ContIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContIacWzskPrsList")}
			valid = basexpath != nil

			let itemtag: String = "ContitemIacWzskPrsList"
		...
		public func writeXML(
			...
			if tag == nil {tag = "ContIacWzskPrsList"}

			let itemtag: String = shorttags ? "Ci" : "ContitemIacWzskPrsList"
	...
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskPrsList")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskPrsList"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskPrsList")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskPrsList"
	...
	public class StgIac: Block {
		...
		public static let TCOTITWIDTH: Int = 3
		public static let TCOFNMWIDTH: Int = 4
		public static let TCOLNMWIDTH: Int = 5
		public static let TCOSEXWIDTH: Int = 6
		public static let TCOTELWIDTH: Int = 7
		public static let TCOEMLWIDTH: Int = 8
		...
		public init(
			...
			self.TcoLnmWidth = TcoLnmWidth
			self.TcoSexWidth = TcoSexWidth
			self.TcoTelWidth = TcoTelWidth
			self.TcoEmlWidth = TcoEmlWidth

			super.init()

			mask = [StgIac.TCOGRPWIDTH, StgIac.TCOOWNWIDTH, StgIac.TCOTITWIDTH, StgIac.TCOFNMWIDTH, StgIac.TCOLNMWIDTH, StgIac.TCOSEXWIDTH, StgIac.TCOTELWIDTH, StgIac.TCOEMLWIDTH]
		}
		...
		public var TcoLnmWidth: Int
		public var TcoSexWidth: Int
		public var TcoTelWidth: Int
		public var TcoEmlWidth: Int
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacWzskPrsList")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacWzskPrsList"
			...
			if valid {
				...
				TcoLnmWidth = Xmlio.extractIntAttrUclc(doc, basexpath!, itemtag, "Si", "sref", "TcoLnmWidth", &mask, StgIac.TCOLNMWIDTH)
				TcoSexWidth = Xmlio.extractIntAttrUclc(doc, basexpath!, itemtag, "Si", "sref", "TcoSexWidth", &mask, StgIac.TCOSEXWIDTH)
				TcoTelWidth = Xmlio.extractIntAttrUclc(doc, basexpath!, itemtag, "Si", "sref", "TcoTelWidth", &mask, StgIac.TCOTELWIDTH)
				TcoEmlWidth = Xmlio.extractIntAttrUclc(doc, basexpath!, itemtag, "Si", "sref", "TcoEmlWidth", &mask, StgIac.TCOEMLWIDTH)
			}
		...
		public func writeXML(
			...
			var tag: String? = difftag
			if tag == nil {tag = "StgIacWzskPrsList"}

			let itemtag: String = shorttags ? "Si" : "StgitemacWzskPrsList"
			...
			Xmlio.writeIntAttr(doc, el, itemtag, "sref", "TcoLnmWidth", TcoLnmWidth)
			Xmlio.writeIntAttr(doc, el, itemtag, "sref", "TcoSexWidth", TcoSexWidth)
			Xmlio.writeIntAttr(doc, el, itemtag, "sref", "TcoTelWidth", TcoTelWidth)
			Xmlio.writeIntAttr(doc, el, itemtag, "sref", "TcoEmlWidth", TcoEmlWidth)
		}
		...
		public func comm(
			...
			if TcoLnmWidth == comp.TcoLnmWidth {items.insert(StgIac.TCOLNMWIDTH)}
			if TcoSexWidth == comp.TcoSexWidth {items.insert(StgIac.TCOSEXWIDTH)}
			if TcoTelWidth == comp.TcoTelWidth {items.insert(StgIac.TCOTELWIDTH)}
			if TcoEmlWidth == comp.TcoEmlWidth {items.insert(StgIac.TCOEMLWIDTH)}
		...
		public func diff(
			...
			let commitems: Set<Int> = comm(comp)
			var diffitems: Set<Int> = [StgIac.TCOGRPWIDTH, StgIac.TCOOWNWIDTH, StgIac.TCOTITWIDTH, StgIac.TCOFNMWIDTH, StgIac.TCOLNMWIDTH, StgIac.TCOSEXWIDTH, StgIac.TCOTELWIDTH, StgIac.TCOEMLWIDTH]
	...
	public class Tag: Block {
		...
		public static let TCOTIT: Int = 9
		public static let TCOFNM: Int = 10
		public static let TCOLNM: Int = 11
		public static let TCOSEX: Int = 12
		public static let TCOTEL: Int = 13
		public static let TCOEML: Int = 14
		...
		public init(
			...
			mask = [Tag.CPT, Tag.TXTRECORD1, Tag.TXTRECORD2, Tag.TRS, Tag.TXTSHOWING1, Tag.TXTSHOWING2, Tag.TCOGRP, Tag.TCOOWN, Tag.TCOTIT, Tag.TCOFNM, Tag.TCOLNM, Tag.TCOSEX, Tag.TCOTEL, Tag.TCOEML]
		}
		...
		public var TcoLnm: String
		public var TcoSex: String
		public var TcoTel: String
		public var TcoEml: String
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskPrsList")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskPrsList"
			...
			if valid {
				...
				TcoLnm = Xmlio.extractStringAttrUclc(doc, basexpath!, itemtag, "Ti", "sref", "TcoLnm", &mask, Tag.TCOLNM)
				TcoSex = Xmlio.extractStringAttrUclc(doc, basexpath!, itemtag, "Ti", "sref", "TcoSex", &mask, Tag.TCOSEX)
				TcoTel = Xmlio.extractStringAttrUclc(doc, basexpath!, itemtag, "Ti", "sref", "TcoTel", &mask, Tag.TCOTEL)
				TcoEml = Xmlio.extractStringAttrUclc(doc, basexpath!, itemtag, "Ti", "sref", "TcoEml", &mask, Tag.TCOEML)
			}
		...
		public func comm(
			...
			if TcoLnm == comp.TcoLnm {items.insert(Tag.TCOLNM)}
			if TcoSex == comp.TcoSex {items.insert(Tag.TCOSEX)}
			if TcoTel == comp.TcoTel {items.insert(Tag.TCOTEL)}
			if TcoEml == comp.TcoEml {items.insert(Tag.TCOEML)}
		...
		public func diff(
			...
			let commitems: Set<Int> = comm(comp)
			var diffitems: Set<Int> = [Tag.CPT, Tag.TXTRECORD1, Tag.TXTRECORD2, Tag.TRS, Tag.TXTSHOWING1, Tag.TXTSHOWING2, Tag.TCOGRP, Tag.TCOOWN, Tag.TCOTIT, Tag.TCOFNM, Tag.TCOLNM, Tag.TCOSEX, Tag.TCOTEL, Tag.TCOEML]
	...
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
					...
					, _ stgiac: StgIac? = nil
					, _ stgiacqry: QryWzskPrsList.StgIac? = nil
					, mask: Set<Int> = []
				) {
			super.init(VecWzskVDpch.DPCHAPPWZSKPRSLISTDATA, scrJref)
		...
		public var stgiacqry: QryWzskPrsList.StgIac = QryWzskPrsList.StgIac()
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskPrsListData")
	...
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKPRSLISTDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskPrsListDo")
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKPRSLISTDATA)
		}
		...
		public var rst: ListWzskQPrsList = ListWzskQPrsList()
		public var statappqry: QryWzskPrsList.StatApp = QryWzskPrsList.StatApp()
		public var statshrqry: QryWzskPrsList.StatShr = QryWzskPrsList.StatShr()
		public var stgiacqry: QryWzskPrsList.StgIac = QryWzskPrsList.StgIac()
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskPrsListData")}
			valid = basexpath != nil
			...
			if valid {
				...
				stgiac = StgIac()
				tag = Tag()
				statappqry = QryWzskPrsList.StatApp()
				statshrqry = QryWzskPrsList.StatShr()
