/**
  * \file QryWzskObjRef1NFile.swift
  * Swift API code for job QryWzskObjRef1NFile
...
/**
	* QryWzskObjRef1NFile
	*/
public class QryWzskObjRef1NFile {
	/**
	  * StatApp (full: StatAppQryWzskObjRef1NFile)
	  */
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskObjRef1NFile")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskObjRef1NFile"
	...
	/**
	  * StatShr (full: StatShrQryWzskObjRef1NFile)
	  */
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskObjRef1NFile")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskObjRef1NFile"
	...
	/**
	  * StgIac (full: StgIacQryWzskObjRef1NFile)
	  */
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskObjRef1NFile")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskObjRef1NFile"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskObjRef1NFile"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskObjRef1NFile"
