/**
  * \file PnlWzskShtHeadbar.swift
  * Swift API code for job PnlWzskShtHeadbar
...
/**
	* PnlWzskShtHeadbar
	*/
public class PnlWzskShtHeadbar {
	/**
	...
	public class StgInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgInfWzskShtHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "StgitemnfWzskShtHeadbar"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskShtHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskShtHeadbar"
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKSHTHEADBARDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskShtHeadbarData")}
			valid = basexpath != nil
