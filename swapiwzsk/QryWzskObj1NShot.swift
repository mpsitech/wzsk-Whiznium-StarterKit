/**
  * \file QryWzskObj1NShot.swift
  * Swift API code for job QryWzskObj1NShot
...
/**
	* QryWzskObj1NShot
	*/
public class QryWzskObj1NShot {
	/**
	  * StatApp (full: StatAppQryWzskObj1NShot)
	  */
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskObj1NShot")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskObj1NShot"
	...
	/**
	  * StatShr (full: StatShrQryWzskObj1NShot)
	  */
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskObj1NShot")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskObj1NShot"
	...
	/**
	  * StgIac (full: StgIacQryWzskObj1NShot)
	  */
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskObj1NShot")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskObj1NShot"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskObj1NShot"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskObj1NShot"
