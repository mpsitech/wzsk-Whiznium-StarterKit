/**
  * \file PnlWzskUsgHeadbar.swift
  * Swift API code for job PnlWzskUsgHeadbar
...
/**
	* PnlWzskUsgHeadbar
	*/
public class PnlWzskUsgHeadbar {
	/**
	...
	public class StgInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgInfWzskUsgHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "StgitemnfWzskUsgHeadbar"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskUsgHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskUsgHeadbar"
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKUSGHEADBARDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskUsgHeadbarData")}
			valid = basexpath != nil
