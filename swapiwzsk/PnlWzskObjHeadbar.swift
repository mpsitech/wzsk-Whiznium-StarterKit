/**
  * \file PnlWzskObjHeadbar.swift
  * Swift API code for job PnlWzskObjHeadbar
...
/**
	* PnlWzskObjHeadbar
	*/
public class PnlWzskObjHeadbar {
	/**
	...
	public class StgInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgInfWzskObjHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "StgitemnfWzskObjHeadbar"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskObjHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskObjHeadbar"
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKOBJHEADBARDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskObjHeadbarData")}
			valid = basexpath != nil
