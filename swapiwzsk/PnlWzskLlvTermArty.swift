/**
  * \file PnlWzskLlvTermArty.swift
  * Swift API code for job PnlWzskLlvTermArty
...
public class PnlWzskLlvTermArty {
	...
	public class ContIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContIacWzskLlvTermArty")}
			valid = basexpath != nil

			let itemtag: String = "ContitemIacWzskLlvTermArty"
		...
		public func writeXML(
			...
			if tag == nil {tag = "ContIacWzskLlvTermArty"}

			let itemtag: String = shorttags ? "Ci" : "ContitemIacWzskLlvTermArty"
	...
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskLlvTermArty")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskLlvTermArty"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskLlvTermArty")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskLlvTermArty"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskLlvTermArty")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskLlvTermArty"
	...
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKLLVTERMARTYDATA, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskLlvTermArtyData")
	...
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKLLVTERMARTYDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskLlvTermArtyDo")
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKLLVTERMARTYDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskLlvTermArtyData")}
			valid = basexpath != nil
