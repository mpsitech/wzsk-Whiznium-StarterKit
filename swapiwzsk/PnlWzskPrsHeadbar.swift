/**
  * \file PnlWzskPrsHeadbar.swift
  * Swift API code for job PnlWzskPrsHeadbar
...
/**
	* PnlWzskPrsHeadbar
	*/
public class PnlWzskPrsHeadbar {
	/**
	...
	public class StgInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgInfWzskPrsHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "StgitemnfWzskPrsHeadbar"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskPrsHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskPrsHeadbar"
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKPRSHEADBARDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskPrsHeadbarData")}
			valid = basexpath != nil
