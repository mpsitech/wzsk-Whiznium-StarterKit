/**
  * \file PnlWzskLlvTermPwmonuart.swift
  * Swift API code for job PnlWzskLlvTermPwmonuart
...
/**
	...
	*/
public class PnlWzskLlvTermPwmonuart {
	/**
		* VecVDo (full: VecVWzskLlvTermPwmonuartDo)
		*/
	public class VecVDo {
	...
	/**
	  * ContIac (full: ContIacWzskLlvTermPwmonuart)
	  */
	public class ContIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContIacWzskLlvTermPwmonuart")}
			valid = basexpath != nil

			let itemtag: String = "ContitemIacWzskLlvTermPwmonuart"
		...
		public func writeXML(
			...
			if tag == nil {tag = "ContIacWzskLlvTermPwmonuart"}

			let itemtag: String = shorttags ? "Ci" : "ContitemIacWzskLlvTermPwmonuart"
	...
	/**
	  * ContInf (full: ContInfWzskLlvTermPwmonuart)
	  */
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskLlvTermPwmonuart")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskLlvTermPwmonuart"
	...
	/**
	  * StatShr (full: StatShrWzskLlvTermPwmonuart)
	  */
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskLlvTermPwmonuart")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskLlvTermPwmonuart"
	...
	/**
	  * Tag (full: TagWzskLlvTermPwmonuart)
	  */
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskLlvTermPwmonuart")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskLlvTermPwmonuart"
	...
	/**
		* DpchAppData (full: DpchAppWzskLlvTermPwmonuartData)
		*/
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKLLVTERMPWMONUARTDATA, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskLlvTermPwmonuartData")
	...
	/**
		* DpchAppDo (full: DpchAppWzskLlvTermPwmonuartDo)
		*/
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKLLVTERMPWMONUARTDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskLlvTermPwmonuartDo")
	...
	/**
		* DpchEngData (full: DpchEngWzskLlvTermPwmonuartData)
		*/
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKLLVTERMPWMONUARTDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskLlvTermPwmonuartData")}
			valid = basexpath != nil
