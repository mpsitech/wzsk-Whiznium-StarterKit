/**
  * \file QryWzskOgrSup1NObjgroup.swift
  * Swift API code for job QryWzskOgrSup1NObjgroup
...
/**
	...
	*/
public class QryWzskOgrSup1NObjgroup {
	/**
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskOgrSup1NObjgroup")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskOgrSup1NObjgroup"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskOgrSup1NObjgroup")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskOgrSup1NObjgroup"
	...
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskOgrSup1NObjgroup")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskOgrSup1NObjgroup"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskOgrSup1NObjgroup"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskOgrSup1NObjgroup"
