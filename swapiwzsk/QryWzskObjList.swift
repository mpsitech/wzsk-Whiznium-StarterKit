/**
  * \file QryWzskObjList.swift
  * Swift API code for job QryWzskObjList
...
/**
	* QryWzskObjList
	*/
public class QryWzskObjList {
	/**
		* VecVOrd (full: VecVQryWzskObjListOrd)
		*/
	public class VecVOrd {

		public static let TIT: Int = 1
		public static let OGR: Int = 2
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskObjList")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskObjList"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskObjList")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskObjList"
	...
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskObjList")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskObjList"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskObjList"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskObjList"
