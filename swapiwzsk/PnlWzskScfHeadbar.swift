/**
  * \file PnlWzskScfHeadbar.swift
  * Swift API code for job PnlWzskScfHeadbar
...
/**
	* PnlWzskScfHeadbar
	*/
public class PnlWzskScfHeadbar {
	/**
	...
	public class StgInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgInfWzskScfHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "StgitemnfWzskScfHeadbar"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskScfHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskScfHeadbar"
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKSCFHEADBARDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskScfHeadbarData")}
			valid = basexpath != nil
