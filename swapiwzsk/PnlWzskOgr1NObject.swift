/**
  * \file PnlWzskOgr1NObject.swift
  * Swift API code for job PnlWzskOgr1NObject
...
/**
	* PnlWzskOgr1NObject
	*/
public class PnlWzskOgr1NObject {
	/**
	...
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskOgr1NObject")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskOgr1NObject"
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppWzskOgr1NObject")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppWzskOgr1NObject"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskOgr1NObject")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskOgr1NObject"
	...
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacWzskOgr1NObject")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacWzskOgr1NObject"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacWzskOgr1NObject"}

			let itemtag: String = shorttags ? "Si" : "StgitemacWzskOgr1NObject"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskOgr1NObject")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskOgr1NObject"
	...
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
					_ scrJref: String = ""
					, _ stgiac: StgIac? = nil
					, _ stgiacqry: QryWzskOgr1NObject.StgIac? = nil
					, mask: Set<Int> = []
				) {
			super.init(VecWzskVDpch.DPCHAPPWZSKOGR1NOBJECTDATA, scrJref)
		...
		public var stgiacqry: QryWzskOgr1NObject.StgIac = QryWzskOgr1NObject.StgIac()
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskOgr1NObjectData")
	...
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKOGR1NOBJECTDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskOgr1NObjectDo")
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKOGR1NOBJECTDATA)
		}
		...
		public var rst: ListWzskQOgr1NObject = ListWzskQOgr1NObject()
		public var statappqry: QryWzskOgr1NObject.StatApp = QryWzskOgr1NObject.StatApp()
		public var statshrqry: QryWzskOgr1NObject.StatShr = QryWzskOgr1NObject.StatShr()
		public var stgiacqry: QryWzskOgr1NObject.StgIac = QryWzskOgr1NObject.StgIac()
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskOgr1NObjectData")}
			valid = basexpath != nil
