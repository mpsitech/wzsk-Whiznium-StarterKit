/**
  * \file PnlWzskLivHeadbar.swift
  * Swift API code for job PnlWzskLivHeadbar
...
/**
	* PnlWzskLivHeadbar
	*/
public class PnlWzskLivHeadbar {
	/**
	...
	public class StgInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgInfWzskLivHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "StgitemnfWzskLivHeadbar"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskLivHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskLivHeadbar"
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKLIVHEADBARDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskLivHeadbarData")}
			valid = basexpath != nil
