/**
  * \file PnlWzskOgrHeadbar.swift
  * Swift API code for job PnlWzskOgrHeadbar
...
/**
	* PnlWzskOgrHeadbar
	*/
public class PnlWzskOgrHeadbar {
	/**
	...
	public class StgInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgInfWzskOgrHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "StgitemnfWzskOgrHeadbar"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskOgrHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskOgrHeadbar"
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKOGRHEADBARDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskOgrHeadbarData")}
			valid = basexpath != nil
