/**
  * \file PnlWzskLlvTermMcvevp.swift
  * Swift API code for job PnlWzskLlvTermMcvevp
...
/**
	...
	*/
public class PnlWzskLlvTermMcvevp {
	/**
		* VecVDo (full: VecVWzskLlvTermMcvevpDo)
		*/
	public class VecVDo {
	...
	/**
	  * ContIac (full: ContIacWzskLlvTermMcvevp)
	  */
	public class ContIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContIacWzskLlvTermMcvevp")}
			valid = basexpath != nil

			let itemtag: String = "ContitemIacWzskLlvTermMcvevp"
		...
		public func writeXML(
			...
			if tag == nil {tag = "ContIacWzskLlvTermMcvevp"}

			let itemtag: String = shorttags ? "Ci" : "ContitemIacWzskLlvTermMcvevp"
	...
	/**
	  * ContInf (full: ContInfWzskLlvTermMcvevp)
	  */
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskLlvTermMcvevp")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskLlvTermMcvevp"
	...
	/**
	  * StatShr (full: StatShrWzskLlvTermMcvevp)
	  */
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskLlvTermMcvevp")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskLlvTermMcvevp"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskLlvTermMcvevp")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskLlvTermMcvevp"
	...
	/**
		* DpchAppData (full: DpchAppWzskLlvTermMcvevpData)
		*/
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKLLVTERMMCVEVPDATA, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskLlvTermMcvevpData")
	...
	/**
		* DpchAppDo (full: DpchAppWzskLlvTermMcvevpDo)
		*/
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKLLVTERMMCVEVPDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskLlvTermMcvevpDo")
	...
	/**
		* DpchEngData (full: DpchEngWzskLlvTermMcvevpData)
		*/
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKLLVTERMMCVEVPDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskLlvTermMcvevpData")}
			valid = basexpath != nil
