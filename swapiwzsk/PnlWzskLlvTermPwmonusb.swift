/**
  * \file PnlWzskLlvTermPwmonusb.swift
  * Swift API code for job PnlWzskLlvTermPwmonusb
...
/**
	...
	*/
public class PnlWzskLlvTermPwmonusb {
	/**
	...
	public class ContIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContIacWzskLlvTermPwmonusb")}
			valid = basexpath != nil

			let itemtag: String = "ContitemIacWzskLlvTermPwmonusb"
		...
		public func writeXML(
			...
			if tag == nil {tag = "ContIacWzskLlvTermPwmonusb"}

			let itemtag: String = shorttags ? "Ci" : "ContitemIacWzskLlvTermPwmonusb"
	...
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskLlvTermPwmonusb")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskLlvTermPwmonusb"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskLlvTermPwmonusb")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskLlvTermPwmonusb"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskLlvTermPwmonusb")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskLlvTermPwmonusb"
	...
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKLLVTERMPWMONUSBDATA, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskLlvTermPwmonusbData")
	...
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKLLVTERMPWMONUSBDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskLlvTermPwmonusbDo")
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKLLVTERMPWMONUSBDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskLlvTermPwmonusbData")}
			valid = basexpath != nil
