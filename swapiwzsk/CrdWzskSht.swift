/**
  * \file CrdWzskSht.swift
  * Swift API code for job CrdWzskSht
...
/**
	* CrdWzskSht
	*/
public class CrdWzskSht {
	/**
		* VecVDo (full: VecVWzskShtDo)
		*/
	public class VecVDo {
	...
	public class ContInf: Block {
		...
		public init(
			...
			self.MtxCrdSht = MtxCrdSht

			super.init()

			mask = [ContInf.NUMFSGE, ContInf.MRLAPPHLP, ContInf.MTXCRDSHT]
		}

		public var numFSge: Int
		public var MrlAppHlp: String
		public var MtxCrdSht: String
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskSht")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskSht"
			...
			if valid {
				...
				MtxCrdSht = Xmlio.extractStringAttrUclc(doc, basexpath!, itemtag, "Ci", "sref", "MtxCrdSht", &mask, ContInf.MTXCRDSHT)
			}
		...
		public func comm(
			...
			if MtxCrdSht == comp.MtxCrdSht {items.insert(ContInf.MTXCRDSHT)}
		...
		public func diff(
			...
			var diffitems: Set<Int> = [ContInf.NUMFSGE, ContInf.MRLAPPHLP, ContInf.MTXCRDSHT]
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppWzskSht")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppWzskSht"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskSht")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskSht"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskSht")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskSht"
	...
	/**
		* DpchAppDo (full: DpchAppWzskShtDo)
		*/
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKSHTDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskShtDo")
	...
	/**
		* DpchEngData (full: DpchEngWzskShtData)
		*/
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKSHTDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskShtData")}
			valid = basexpath != nil
