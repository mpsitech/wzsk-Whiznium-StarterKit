/**
  * \file PnlWzskUsgAAccess.java
  * Java API code for job PnlWzskUsgAAccess
...
public class PnlWzskUsgAAccess {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskUsgAAccess");

			String itemtag = "ContitemInfWzskUsgAAccess";
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWzskUsgAAccess");

			String itemtag = "StatitemAppWzskUsgAAccess";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskUsgAAccess");

			String itemtag = "StatitemShrWzskUsgAAccess";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWzskUsgAAccess");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWzskUsgAAccess";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskUsgAAccess");

			String itemtag = "TagitemWzskUsgAAccess";
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKUSGAACCESSDATA, scrJref);
		...
		public QryWzskUsgAAccess.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskUsgAAccessData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKUSGAACCESSDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskUsgAAccessDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKUSGAACCESSDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWzskQUsgAAccess();
			statappqry = (new QryWzskUsgAAccess()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWzskUsgAAccess()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWzskUsgAAccess()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWzskQUsgAAccess rst;
		public QryWzskUsgAAccess.StatApp statappqry;
		public QryWzskUsgAAccess.StatShr statshrqry;
		public QryWzskUsgAAccess.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskUsgAAccessData");
