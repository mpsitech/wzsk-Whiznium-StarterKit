/**
  * \file PnlWzskSes1NShot.java
  * Java API code for job PnlWzskSes1NShot
...
public class PnlWzskSes1NShot {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskSes1NShot");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWzskSes1NShot");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskSes1NShot");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWzskSes1NShot");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWzskSes1NShot";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskSes1NShot");
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKSES1NSHOTDATA, scrJref);
		...
		public QryWzskSes1NShot.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskSes1NShotData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKSES1NSHOTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskSes1NShotDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKSES1NSHOTDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWzskQSes1NShot();
			statappqry = (new QryWzskSes1NShot()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWzskSes1NShot()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWzskSes1NShot()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWzskQSes1NShot rst;
		public QryWzskSes1NShot.StatApp statappqry;
		public QryWzskSes1NShot.StatShr statshrqry;
		public QryWzskSes1NShot.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskSes1NShotData");
