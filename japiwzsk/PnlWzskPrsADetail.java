...
public class PnlWzskPrsADetail {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskPrsADetail");

			String itemtag = "ContitemInfWzskPrsADetail";
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWzskPrsADetail");

			String itemtag = "StatitemAppWzskPrsADetail";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskPrsADetail");

			String itemtag = "StatitemShrWzskPrsADetail";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWzskPrsADetail");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWzskPrsADetail";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskPrsADetail");

			String itemtag = "TagitemWzskPrsADetail";
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKPRSADETAILDATA, scrJref);
		...
		public QryWzskPrsADetail.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskPrsADetailData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKPRSADETAILDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskPrsADetailDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKPRSADETAILDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWzskQPrsADetail();
			statappqry = (new QryWzskPrsADetail()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWzskPrsADetail()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWzskPrsADetail()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWzskQPrsADetail rst;
		public QryWzskPrsADetail.StatApp statappqry;
		public QryWzskPrsADetail.StatShr statshrqry;
		public QryWzskPrsADetail.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskPrsADetailData");
