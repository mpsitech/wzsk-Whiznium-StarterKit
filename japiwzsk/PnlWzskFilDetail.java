/**
  * \file PnlWzskFilDetail.java
  * Java API code for job PnlWzskFilDetail
...
public class PnlWzskFilDetail {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWzskFilDetail");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWzskFilDetail";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskFilDetail");
	...
	public class StatApp extends Block {
		...
		public StatApp(
			...
			mask = new HashSet<Integer>(Arrays.asList(IXWZSKVEXPSTATE, LSTCLUALT, PUPCNTALT, PUPMIMALT, LSTCLUNUMFIRSTDISP));
		};
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWzskFilDetail");
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(IXWZSKVEXPSTATE, LSTCLUALT, PUPCNTALT, PUPMIMALT, LSTCLUNUMFIRSTDISP));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskFilDetail");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskFilDetail");
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKFILDETAILDATA, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskFilDetailData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKFILDETAILDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskFilDetailDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKFILDETAILDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskFilDetailData");
