/**
  * \file PnlWzskLlvTermPwmonusb.java
  * Java API code for job PnlWzskLlvTermPwmonusb
...
public class PnlWzskLlvTermPwmonusb {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWzskLlvTermPwmonusb");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWzskLlvTermPwmonusb";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskLlvTermPwmonusb");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskLlvTermPwmonusb");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskLlvTermPwmonusb");
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKLLVTERMPWMONUSBDATA, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskLlvTermPwmonusbData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKLLVTERMPWMONUSBDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskLlvTermPwmonusbDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKLLVTERMPWMONUSBDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskLlvTermPwmonusbData");
