...
public class PnlWzskOgrSup1NObjgroup {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskOgrSup1NObjgroup");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWzskOgrSup1NObjgroup");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskOgrSup1NObjgroup");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWzskOgrSup1NObjgroup");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWzskOgrSup1NObjgroup";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskOgrSup1NObjgroup");
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKOGRSUP1NOBJGROUPDATA, scrJref);
		...
		public QryWzskOgrSup1NObjgroup.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskOgrSup1NObjgroupData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKOGRSUP1NOBJGROUPDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskOgrSup1NObjgroupDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKOGRSUP1NOBJGROUPDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWzskQOgrSup1NObjgroup();
			statappqry = (new QryWzskOgrSup1NObjgroup()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWzskOgrSup1NObjgroup()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWzskOgrSup1NObjgroup()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWzskQOgrSup1NObjgroup rst;
		public QryWzskOgrSup1NObjgroup.StatApp statappqry;
		public QryWzskOgrSup1NObjgroup.StatShr statshrqry;
		public QryWzskOgrSup1NObjgroup.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskOgrSup1NObjgroupData");
