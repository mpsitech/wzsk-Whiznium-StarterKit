/**
  * \file PnlWzskUsrAAccess.java
  * Java API code for job PnlWzskUsrAAccess
...
public class PnlWzskUsrAAccess {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskUsrAAccess");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWzskUsrAAccess");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskUsrAAccess");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWzskUsrAAccess");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWzskUsrAAccess";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskUsrAAccess");
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKUSRAACCESSDATA, scrJref);
		...
		public QryWzskUsrAAccess.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskUsrAAccessData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKUSRAACCESSDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskUsrAAccessDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKUSRAACCESSDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "");
			rst = new ListWzskQUsrAAccess();
			statappqry = (new QryWzskUsrAAccess()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWzskUsrAAccess()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWzskUsrAAccess()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWzskQUsrAAccess rst;
		public QryWzskUsrAAccess.StatApp statappqry;
		public QryWzskUsrAAccess.StatShr statshrqry;
		public QryWzskUsrAAccess.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskUsrAAccessData");
