/**
  * \file QryWzskObjList.java
  * Java API code for job QryWzskObjList
...
public class QryWzskObjList {
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWzskObjList");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWzskObjList");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWzskObjList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWzskObjList";
