/**
  * \file QryWzskOgr1NShot.java
  * Java API code for job QryWzskOgr1NShot
...
public class QryWzskOgr1NShot {
	/**
	  * StatApp (full: StatAppQryWzskOgr1NShot)
	  */
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWzskOgr1NShot");
	...
	/**
	  * StatShr (full: StatShrQryWzskOgr1NShot)
	  */
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWzskOgr1NShot");
	...
	/**
	  * StgIac (full: StgIacQryWzskOgr1NShot)
	  */
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWzskOgr1NShot");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWzskOgr1NShot";
