/**
	* \file ContInfWzskAlert.java
	* Wzsk Java API package alert informative content block
...
public class ContInfWzskAlert extends Block {
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskAlert");
