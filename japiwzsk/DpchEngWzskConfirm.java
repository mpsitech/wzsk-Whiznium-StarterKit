...
public class DpchEngWzskConfirm extends DpchEngWzsk {

	public static final int ACCEPTED = 1;
	public static final int SCRJREF = 2;
	public static final int SREF = 3;

	public DpchEngWzskConfirm() {
		super(VecWzskVDpch.DPCHENGWZSKCONFIRM);
	...
	public void readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskConfirm");
