/**
  * \file PnlWzskPrsList.java
  * Java API code for job PnlWzskPrsList
...
public class PnlWzskPrsList {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWzskPrsList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWzskPrsList";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskPrsList");

			String itemtag = "ContitemInfWzskPrsList";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskPrsList");

			String itemtag = "StatitemShrWzskPrsList";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWzskPrsList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWzskPrsList";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskPrsList");

			String itemtag = "TagitemWzskPrsList";
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKPRSLISTDATA, scrJref);
		...
		public QryWzskPrsList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskPrsListData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKPRSLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskPrsListDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKPRSLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWzskQPrsList();
			statappqry = (new QryWzskPrsList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWzskPrsList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWzskPrsList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWzskQPrsList rst;
		public QryWzskPrsList.StatApp statappqry;
		public QryWzskPrsList.StatShr statshrqry;
		public QryWzskPrsList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskPrsListData");
