/**
  * \file PnlWzskOgr1NObject.java
  * Java API code for job PnlWzskOgr1NObject
...
public class PnlWzskOgr1NObject {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskOgr1NObject");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWzskOgr1NObject");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskOgr1NObject");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWzskOgr1NObject");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWzskOgr1NObject";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskOgr1NObject");
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKOGR1NOBJECTDATA, scrJref);
		...
		public QryWzskOgr1NObject.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskOgr1NObjectData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKOGR1NOBJECTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskOgr1NObjectDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKOGR1NOBJECTDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWzskQOgr1NObject();
			statappqry = (new QryWzskOgr1NObject()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWzskOgr1NObject()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWzskOgr1NObject()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWzskQOgr1NObject rst;
		public QryWzskOgr1NObject.StatApp statappqry;
		public QryWzskOgr1NObject.StatShr statshrqry;
		public QryWzskOgr1NObject.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskOgr1NObjectData");
