/**
  * \file PnlWzskOgr1NShot.java
  * Java API code for job PnlWzskOgr1NShot
...
public class PnlWzskOgr1NShot {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskOgr1NShot");

			String itemtag = "ContitemInfWzskOgr1NShot";
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWzskOgr1NShot");

			String itemtag = "StatitemAppWzskOgr1NShot";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskOgr1NShot");

			String itemtag = "StatitemShrWzskOgr1NShot";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWzskOgr1NShot");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWzskOgr1NShot";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskOgr1NShot");

			String itemtag = "TagitemWzskOgr1NShot";
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKOGR1NSHOTDATA, scrJref);
		...
		public QryWzskOgr1NShot.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskOgr1NShotData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKOGR1NSHOTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskOgr1NShotDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKOGR1NSHOTDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWzskQOgr1NShot();
			statappqry = (new QryWzskOgr1NShot()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWzskOgr1NShot()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWzskOgr1NShot()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWzskQOgr1NShot rst;
		public QryWzskOgr1NShot.StatApp statappqry;
		public QryWzskOgr1NShot.StatShr statshrqry;
		public QryWzskOgr1NShot.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskOgr1NShotData");
