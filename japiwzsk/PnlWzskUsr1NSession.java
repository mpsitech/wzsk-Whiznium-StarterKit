/**
  * \file PnlWzskUsr1NSession.java
  * Java API code for job PnlWzskUsr1NSession
...
public class PnlWzskUsr1NSession {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskUsr1NSession");

			String itemtag = "ContitemInfWzskUsr1NSession";
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWzskUsr1NSession");

			String itemtag = "StatitemAppWzskUsr1NSession";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskUsr1NSession");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWzskUsr1NSession");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWzskUsr1NSession";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskUsr1NSession");

			String itemtag = "TagitemWzskUsr1NSession";
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKUSR1NSESSIONDATA, scrJref);
		...
		public QryWzskUsr1NSession.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskUsr1NSessionData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKUSR1NSESSIONDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskUsr1NSessionDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKUSR1NSESSIONDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWzskQUsr1NSession();
			statappqry = (new QryWzskUsr1NSession()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWzskUsr1NSession()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWzskUsr1NSession()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWzskQUsr1NSession rst;
		public QryWzskUsr1NSession.StatApp statappqry;
		public QryWzskUsr1NSession.StatShr statshrqry;
		public QryWzskUsr1NSession.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskUsr1NSessionData");
