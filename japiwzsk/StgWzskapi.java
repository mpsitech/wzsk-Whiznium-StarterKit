/**
  * \file StgWzskapi.java
  * Wzsk Java API package settings block
...
public class StgWzskapi extends Block {
	...
	public boolean readXML(
		...
		if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgWzskapi");
	...
	public void writeXML(
		...
		if (difftag.isEmpty()) difftag = "StgWzskapi";
		
		String itemtag;
		
		if (shorttags) itemtag = "Si";
		else itemtag = "StgitemWzskapi";
