/**
  * \file QryWzskOgrSup1NObjgroup.java
  * Java API code for job QryWzskOgrSup1NObjgroup
...
public class QryWzskOgrSup1NObjgroup {
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWzskOgrSup1NObjgroup");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWzskOgrSup1NObjgroup");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWzskOgrSup1NObjgroup");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWzskOgrSup1NObjgroup";
