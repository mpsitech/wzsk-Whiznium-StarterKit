/**
  * \file PnlWzskObj1NShot.java
  * Java API code for job PnlWzskObj1NShot
...
public class PnlWzskObj1NShot {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskObj1NShot");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWzskObj1NShot");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskObj1NShot");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWzskObj1NShot");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWzskObj1NShot";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskObj1NShot");
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKOBJ1NSHOTDATA, scrJref);
		...
		public QryWzskObj1NShot.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskObj1NShotData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKOBJ1NSHOTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskObj1NShotDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKOBJ1NSHOTDATA);
			...
			stgiac = new StgIac(0);
			tag = new Tag("", "", "", "", "", "", "");
			rst = new ListWzskQObj1NShot();
			statappqry = (new QryWzskObj1NShot()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWzskObj1NShot()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWzskObj1NShot()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWzskQObj1NShot rst;
		public QryWzskObj1NShot.StatApp statappqry;
		public QryWzskObj1NShot.StatShr statshrqry;
		public QryWzskObj1NShot.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskObj1NShotData");
