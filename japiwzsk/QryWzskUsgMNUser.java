/**
  * \file QryWzskUsgMNUser.java
  * Java API code for job QryWzskUsgMNUser
...
public class QryWzskUsgMNUser {
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWzskUsgMNUser");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWzskUsgMNUser");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWzskUsgMNUser");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWzskUsgMNUser";
