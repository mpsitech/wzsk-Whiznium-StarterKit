/**
  * \file DlgWzskScfTtablecoord.java
  * Java API code for job DlgWzskScfTtablecoord
...
public class DlgWzskScfTtablecoord {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacDlgWzskScfTtablecoord");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacDlgWzskScfTtablecoord";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfDlgWzskScfTtablecoord");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppDlgWzskScfTtablecoord");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrDlgWzskScfTtablecoord");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagDlgWzskScfTtablecoord");
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPDLGWZSKSCFTTABLECOORDDATA, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWzskScfTtablecoordData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPDLGWZSKSCFTTABLECOORDDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppDlgWzskScfTtablecoordDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public static final int FEEDFDSE = 4;
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGDLGWZSKSCFTTABLECOORDDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngDlgWzskScfTtablecoordData");
