/**
  * \file PnlWzskLlvTermMcvevp.java
  * Java API code for job PnlWzskLlvTermMcvevp
...
public class PnlWzskLlvTermMcvevp {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWzskLlvTermMcvevp");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWzskLlvTermMcvevp";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskLlvTermMcvevp");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskLlvTermMcvevp");
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskLlvTermMcvevp");
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKLLVTERMMCVEVPDATA, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskLlvTermMcvevpData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKLLVTERMMCVEVPDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskLlvTermMcvevpDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKLLVTERMMCVEVPDATA);
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskLlvTermMcvevpData");
