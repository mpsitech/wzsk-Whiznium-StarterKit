/**
  * \file PnlWzskUsgMNUser.java
  * Java API code for job PnlWzskUsgMNUser
...
public class PnlWzskUsgMNUser {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskUsgMNUser");
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWzskUsgMNUser");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskUsgMNUser");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWzskUsgMNUser");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWzskUsgMNUser";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskUsgMNUser");
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKUSGMNUSERDATA, scrJref);
		...
		public QryWzskUsgMNUser.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskUsgMNUserData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKUSGMNUSERDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskUsgMNUserDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKUSGMNUSERDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWzskQUsgMNUser();
			statappqry = (new QryWzskUsgMNUser()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWzskUsgMNUser()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWzskUsgMNUser()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWzskQUsgMNUser rst;
		public QryWzskUsgMNUser.StatApp statappqry;
		public QryWzskUsgMNUser.StatShr statshrqry;
		public QryWzskUsgMNUser.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskUsgMNUserData");
