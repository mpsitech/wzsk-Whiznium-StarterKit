/**
  * \file PnlWzskUsrList.java
  * Java API code for job PnlWzskUsrList
...
public class PnlWzskUsrList {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWzskUsrList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWzskUsrList";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskUsrList");

			String itemtag = "ContitemInfWzskUsrList";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskUsrList");

			String itemtag = "StatitemShrWzskUsrList";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWzskUsrList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWzskUsrList";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskUsrList");

			String itemtag = "TagitemWzskUsrList";
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKUSRLISTDATA, scrJref);
		...
		public QryWzskUsrList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskUsrListData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKUSRLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskUsrListDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKUSRLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "", "", "", "", "");
			rst = new ListWzskQUsrList();
			statappqry = (new QryWzskUsrList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWzskUsrList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWzskUsrList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWzskQUsrList rst;
		public QryWzskUsrList.StatApp statappqry;
		public QryWzskUsrList.StatShr statshrqry;
		public QryWzskUsrList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskUsrListData");
