/**
  * \file PnlWzskShtAPar.java
  * Java API code for job PnlWzskShtAPar
...
public class PnlWzskShtAPar {
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskShtAPar");

			String itemtag = "ContitemInfWzskShtAPar";
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppWzskShtAPar");

			String itemtag = "StatitemAppWzskShtAPar";
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskShtAPar");

			String itemtag = "StatitemShrWzskShtAPar";
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWzskShtAPar");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWzskShtAPar";
	...
	public class Tag extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskShtAPar");

			String itemtag = "TagitemWzskShtAPar";
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKSHTAPARDATA, scrJref);
		...
		public QryWzskShtAPar.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskShtAParData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKSHTAPARDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskShtAParDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKSHTAPARDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "");
			rst = new ListWzskQShtAPar();
			statappqry = (new QryWzskShtAPar()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWzskShtAPar()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWzskShtAPar()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWzskQShtAPar rst;
		public QryWzskShtAPar.StatApp statappqry;
		public QryWzskShtAPar.StatShr statshrqry;
		public QryWzskShtAPar.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskShtAParData");
