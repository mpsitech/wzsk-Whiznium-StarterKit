/**
  * \file QryWzskUsgAAccess.java
  * Java API code for job QryWzskUsgAAccess
...
public class QryWzskUsgAAccess {
	...
	public class StatApp extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatAppQryWzskUsgAAccess");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrQryWzskUsgAAccess");
	...
	public class StgIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacQryWzskUsgAAccess");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacQryWzskUsgAAccess";
