/**
  * \file PnlWzskShtList.java
  * Java API code for job PnlWzskShtList
...
public class PnlWzskShtList {
	...
	public class ContIac extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContIacWzskShtList");
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "ContIacWzskShtList";
	...
	public class ContInf extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "ContInfWzskShtList");
	...
	public class StatShr extends Block {
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StatShrWzskShtList");
	...
	public class StgIac extends Block {
		...
		public static final int TCOSESWIDTH = 1;
		public static final int TCOOBJWIDTH = 2;
		public static final int TCOSTAWIDTH = 3;
		...
		public StgIac(
			...
			mask = new HashSet<Integer>(Arrays.asList(TCOSESWIDTH, TCOOBJWIDTH, TCOSTAWIDTH));
		};

		public int TcoSesWidth;
		public int TcoObjWidth;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "StgIacWzskShtList");

			String itemtag = "StgitemIacWzskShtList";

			if (Xmlio.checkXPath(doc, basexpath)) {
				TcoSesWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoSesWidth", mask, TCOSESWIDTH);
				TcoObjWidth = Xmlio.extractIntegerAttrUclc(doc, basexpath, itemtag, "Si", "sref", "TcoObjWidth", mask, TCOOBJWIDTH);
		...
		public void writeXML(
			...
			if (difftag.isEmpty()) difftag = "StgIacWzskShtList";
			...
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoSesWidth", TcoSesWidth);
			Xmlio.writeIntegerAttr(doc, el, itemtag, "sref", "TcoObjWidth", TcoObjWidth);
		...
		public HashSet<Integer> comm(
			...
			if (TcoSesWidth == comp.TcoSesWidth) items.add(TCOSESWIDTH);
			if (TcoObjWidth == comp.TcoObjWidth) items.add(TCOOBJWIDTH);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(TCOSESWIDTH, TCOOBJWIDTH, TCOSTAWIDTH));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class Tag extends Block {
		...
		public static final int TCOSES = 8;
		public static final int TCOOBJ = 9;
		public static final int TCOSTA = 10;
		...
		public Tag(
			...
			mask = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSES, TCOOBJ, TCOSTA));
		};
		...
		public String TcoSes;
		public String TcoObj;
		...
		public boolean readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "TagWzskShtList");
			...
			if (Xmlio.checkXPath(doc, basexpath)) {
				...
				TcoSes = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoSes", mask, TCOSES);
				TcoObj = Xmlio.extractStringAttrUclc(doc, basexpath, itemtag, "Ti", "sref", "TcoObj", mask, TCOOBJ);
		...
		public HashSet<Integer> comm(
			...
			if (TcoSes.equals(comp.TcoSes)) items.add(TCOSES);
			if (TcoObj.equals(comp.TcoObj)) items.add(TCOOBJ);
		...
		public HashSet<Integer> diff(
			...
			diffitems = new HashSet<Integer>(Arrays.asList(CPT, TXTFOR, TXTRECORD1, TXTRECORD2, TRS, TXTSHOWING1, TXTSHOWING2, TCOSES, TCOOBJ, TCOSTA));
			for (Integer ci: commitems) diffitems.remove(ci);
	...
	public class DpchAppData extends DpchAppWzsk {
		...
		public DpchAppData(
			...
			super(VecWzskVDpch.DPCHAPPWZSKSHTLISTDATA, scrJref);
		...
		public QryWzskShtList.StgIac stgiacqry;
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskShtListData");
	...
	public class DpchAppDo extends DpchAppWzsk {
		...
		public DpchAppDo(
			...
			super(VecWzskVDpch.DPCHAPPWZSKSHTLISTDO, scrJref);
		...
		public void writeXML(
			...
			Element el = doc.createElement("DpchAppWzskShtListDo");
	...
	public class DpchEngData extends DpchEngWzsk {
		...
		public DpchEngData() {
			super(VecWzskVDpch.DPCHENGWZSKSHTLISTDATA);
			...
			tag = new Tag("", "", "", "", "", "", "", "", "", "");
			rst = new ListWzskQShtList();
			statappqry = (new QryWzskShtList()).new StatApp(0, 0, 0, 0);
			statshrqry = (new QryWzskShtList()).new StatShr(0, 0, 0);
			stgiacqry = (new QryWzskShtList()).new StgIac(0, 0, 0);
		};
		...
		public StgIac stgiac;
		public Tag tag;
		public ListWzskQShtList rst;
		public QryWzskShtList.StatApp statappqry;
		public QryWzskShtList.StatShr statshrqry;
		public QryWzskShtList.StgIac stgiacqry;
		...
		public void readXML(
			...
			if (addbasetag) basexpath = Xmlio.checkUclcXPaths(doc, basexpath, "DpchEngWzskShtListData");
