/**
  * \file QryWzskSes1NShot.swift
  * Swift API code for job QryWzskSes1NShot
...
public class QryWzskSes1NShot {
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskSes1NShot")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskSes1NShot"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskSes1NShot")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskSes1NShot"
	...
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskSes1NShot")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskSes1NShot"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskSes1NShot"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskSes1NShot"
