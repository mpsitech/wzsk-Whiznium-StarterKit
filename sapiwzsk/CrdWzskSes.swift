/**
  * \file CrdWzskSes.swift
  * Swift API code for job CrdWzskSes
...
public class CrdWzskSes {
	...
	public class ContInf: Block {
		...
		public static let MTXCRDSES: Int = 3
		...
		public init(
			...
			self.MtxCrdSes = MtxCrdSes

			super.init()

			mask = [ContInf.NUMFSGE, ContInf.MRLAPPHLP, ContInf.MTXCRDSES]
		}

		public var numFSge: Int
		public var MrlAppHlp: String
		public var MtxCrdSes: String
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskSes")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskSes"
			...
			if valid {
				...
				MtxCrdSes = Xmlio.extractStringAttrUclc(doc, basexpath!, itemtag, "Ci", "sref", "MtxCrdSes", &mask, ContInf.MTXCRDSES)
			}
		...
		public func comm(
			...
			if MtxCrdSes == comp.MtxCrdSes {items.insert(ContInf.MTXCRDSES)}
		...
		public func diff(
			...
			var diffitems: Set<Int> = [ContInf.NUMFSGE, ContInf.MRLAPPHLP, ContInf.MTXCRDSES]
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppWzskSes")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppWzskSes"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskSes")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskSes"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskSes")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskSes"
	...
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKSESDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskSesDo")
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKSESDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskSesData")}
			valid = basexpath != nil
