/**
  * \file PnlWzskUsr1NSession.swift
  * Swift API code for job PnlWzskUsr1NSession
...
/**
	* PnlWzskUsr1NSession
	*/
public class PnlWzskUsr1NSession {
	/**
		* VecVDo (full: VecVWzskUsr1NSessionDo)
		*/
	public class VecVDo {
	...
	/**
	  * ContInf (full: ContInfWzskUsr1NSession)
	  */
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskUsr1NSession")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskUsr1NSession"
	...
	/**
	  * StatApp (full: StatAppWzskUsr1NSession)
	  */
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppWzskUsr1NSession")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppWzskUsr1NSession"
	...
	/**
	  * StatShr (full: StatShrWzskUsr1NSession)
	  */
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskUsr1NSession")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskUsr1NSession"
	...
	/**
	  * StgIac (full: StgIacWzskUsr1NSession)
	  */
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacWzskUsr1NSession")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacWzskUsr1NSession"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacWzskUsr1NSession"}

			let itemtag: String = shorttags ? "Si" : "StgitemacWzskUsr1NSession"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskUsr1NSession")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskUsr1NSession"
	...
	/**
		* DpchAppData (full: DpchAppWzskUsr1NSessionData)
		*/
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
					_ scrJref: String = ""
					, _ stgiac: StgIac? = nil
					, _ stgiacqry: QryWzskUsr1NSession.StgIac? = nil
					, mask: Set<Int> = []
				) {
			super.init(VecWzskVDpch.DPCHAPPWZSKUSR1NSESSIONDATA, scrJref)
		...
		public var stgiacqry: QryWzskUsr1NSession.StgIac = QryWzskUsr1NSession.StgIac()
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskUsr1NSessionData")
	...
	/**
		* DpchAppDo (full: DpchAppWzskUsr1NSessionDo)
		*/
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKUSR1NSESSIONDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskUsr1NSessionDo")
	...
	/**
		* DpchEngData (full: DpchEngWzskUsr1NSessionData)
		*/
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKUSR1NSESSIONDATA)
		}
		...
		public var rst: ListWzskQUsr1NSession = ListWzskQUsr1NSession()
		public var statappqry: QryWzskUsr1NSession.StatApp = QryWzskUsr1NSession.StatApp()
		public var statshrqry: QryWzskUsr1NSession.StatShr = QryWzskUsr1NSession.StatShr()
		public var stgiacqry: QryWzskUsr1NSession.StgIac = QryWzskUsr1NSession.StgIac()
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskUsr1NSessionData")}
			valid = basexpath != nil
			...
			if valid {
				...
				stgiac = StgIac()
				tag = Tag()
				statappqry = QryWzskUsr1NSession.StatApp()
				statshrqry = QryWzskUsr1NSession.StatShr()
