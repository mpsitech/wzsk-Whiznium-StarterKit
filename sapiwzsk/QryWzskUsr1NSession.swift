/**
  * \file QryWzskUsr1NSession.swift
  * Swift API code for job QryWzskUsr1NSession
...
/**
	* QryWzskUsr1NSession
	*/
public class QryWzskUsr1NSession {
	/**
	  * StatApp (full: StatAppQryWzskUsr1NSession)
	  */
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskUsr1NSession")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskUsr1NSession"
	...
	/**
	  * StatShr (full: StatShrQryWzskUsr1NSession)
	  */
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskUsr1NSession")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskUsr1NSession"
	...
	/**
	  * StgIac (full: StgIacQryWzskUsr1NSession)
	  */
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskUsr1NSession")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskUsr1NSession"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskUsr1NSession"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskUsr1NSession"
