/**
  * \file DlgWzskScfLaserpos.swift
  * Swift API code for job DlgWzskScfLaserpos
...
/**
	* DlgWzskScfLaserpos
	*/
public class DlgWzskScfLaserpos {
	/**
	...
	public class ContIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContIacDlgWzskScfLaserpos")}
			valid = basexpath != nil

			let itemtag: String = "ContitemIacDlgWzskScfLaserpos"
		...
		public func writeXML(
			...
			if tag == nil {tag = "ContIacDlgWzskScfLaserpos"}

			let itemtag: String = shorttags ? "Ci" : "ContitemIacDlgWzskScfLaserpos"
	...
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfDlgWzskScfLaserpos")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfDlgWzskScfLaserpos"
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppDlgWzskScfLaserpos")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppDlgWzskScfLaserpos"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrDlgWzskScfLaserpos")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrDlgWzskScfLaserpos"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagDlgWzskScfLaserpos")}
			valid = basexpath != nil

			let itemtag: String = "TagitemlgWzskScfLaserpos"
	...
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPDLGWZSKSCFLASERPOSDATA, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppDlgWzskScfLaserposData")
	...
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPDLGWZSKSCFLASERPOSDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppDlgWzskScfLaserposDo")
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGDLGWZSKSCFLASERPOSDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngDlgWzskScfLaserposData")}
			valid = basexpath != nil
