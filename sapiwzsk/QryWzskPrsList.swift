/**
  * \file QryWzskPrsList.swift
  * Swift API code for job QryWzskPrsList
...
public class QryWzskPrsList {
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskPrsList")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskPrsList"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskPrsList")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskPrsList"
	...
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskPrsList")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskPrsList"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskPrsList"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskPrsList"
