/**
  * \file DlgWzskScfCameramat.swift
  * Swift API code for job DlgWzskScfCameramat
...
/**
	* DlgWzskScfCameramat
	*/
public class DlgWzskScfCameramat {
	/**
	...
	public class ContIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContIacDlgWzskScfCameramat")}
			valid = basexpath != nil

			let itemtag: String = "ContitemIacDlgWzskScfCameramat"
		...
		public func writeXML(
			...
			if tag == nil {tag = "ContIacDlgWzskScfCameramat"}

			let itemtag: String = shorttags ? "Ci" : "ContitemIacDlgWzskScfCameramat"
	...
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfDlgWzskScfCameramat")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfDlgWzskScfCameramat"
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppDlgWzskScfCameramat")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppDlgWzskScfCameramat"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrDlgWzskScfCameramat")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrDlgWzskScfCameramat"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagDlgWzskScfCameramat")}
			valid = basexpath != nil

			let itemtag: String = "TagitemlgWzskScfCameramat"
	...
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPDLGWZSKSCFCAMERAMATDATA, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppDlgWzskScfCameramatData")
	...
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPDLGWZSKSCFCAMERAMATDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppDlgWzskScfCameramatDo")
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGDLGWZSKSCFCAMERAMATDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngDlgWzskScfCameramatData")}
			valid = basexpath != nil
