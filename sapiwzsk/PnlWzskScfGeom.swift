/**
  * \file PnlWzskScfGeom.swift
  * Swift API code for job PnlWzskScfGeom
...
public class PnlWzskScfGeom {
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskScfGeom")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskScfGeom"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskScfGeom")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskScfGeom"
	...
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKSCFGEOMDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskScfGeomDo")
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKSCFGEOMDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskScfGeomData")}
			valid = basexpath != nil
