/**
  * \file QryWzskShtList.swift
  * Swift API code for job QryWzskShtList
...
/**
	* QryWzskShtList
	*/
public class QryWzskShtList {
	/**
		* VecVOrd (full: VecVQryWzskShtListOrd)
		*/
	public class VecVOrd {

		public static let SES: Int = 1
		public static let OBJ: Int = 2
		public static let STA: Int = 3
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskShtList")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskShtList"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskShtList")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskShtList"
	...
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskShtList")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskShtList"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskShtList"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskShtList"
