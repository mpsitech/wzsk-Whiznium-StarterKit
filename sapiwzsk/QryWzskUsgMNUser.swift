/**
  * \file QryWzskUsgMNUser.swift
  * Swift API code for job QryWzskUsgMNUser
...
/**
	* QryWzskUsgMNUser
	*/
public class QryWzskUsgMNUser {
	/**
	  * StatApp (full: StatAppQryWzskUsgMNUser)
	  */
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskUsgMNUser")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskUsgMNUser"
	...
	/**
	  * StatShr (full: StatShrQryWzskUsgMNUser)
	  */
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskUsgMNUser")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskUsgMNUser"
	...
	/**
	  * StgIac (full: StgIacQryWzskUsgMNUser)
	  */
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskUsgMNUser")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskUsgMNUser"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskUsgMNUser"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskUsgMNUser"
