/**
  * \file PnlWzskShtRef1NFile.swift
  * Swift API code for job PnlWzskShtRef1NFile
...
/**
	* PnlWzskShtRef1NFile
	*/
public class PnlWzskShtRef1NFile {
	/**
		* VecVDo (full: VecVWzskShtRef1NFileDo)
		*/
	public class VecVDo {
	...
	/**
	  * ContInf (full: ContInfWzskShtRef1NFile)
	  */
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskShtRef1NFile")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskShtRef1NFile"
	...
	/**
	  * StatApp (full: StatAppWzskShtRef1NFile)
	  */
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppWzskShtRef1NFile")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppWzskShtRef1NFile"
	...
	/**
	  * StatShr (full: StatShrWzskShtRef1NFile)
	  */
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskShtRef1NFile")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskShtRef1NFile"
	...
	/**
	  * StgIac (full: StgIacWzskShtRef1NFile)
	  */
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacWzskShtRef1NFile")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacWzskShtRef1NFile"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacWzskShtRef1NFile"}

			let itemtag: String = shorttags ? "Si" : "StgitemacWzskShtRef1NFile"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskShtRef1NFile")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskShtRef1NFile"
	...
	/**
		* DpchAppData (full: DpchAppWzskShtRef1NFileData)
		*/
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
					_ scrJref: String = ""
					, _ stgiac: StgIac? = nil
					, _ stgiacqry: QryWzskShtRef1NFile.StgIac? = nil
					, mask: Set<Int> = []
				) {
			super.init(VecWzskVDpch.DPCHAPPWZSKSHTREF1NFILEDATA, scrJref)
		...
		public var stgiacqry: QryWzskShtRef1NFile.StgIac = QryWzskShtRef1NFile.StgIac()
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskShtRef1NFileData")
	...
	/**
		* DpchAppDo (full: DpchAppWzskShtRef1NFileDo)
		*/
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKSHTREF1NFILEDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskShtRef1NFileDo")
	...
	/**
		* DpchEngData (full: DpchEngWzskShtRef1NFileData)
		*/
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKSHTREF1NFILEDATA)
		}
		...
		public var rst: ListWzskQShtRef1NFile = ListWzskQShtRef1NFile()
		public var statappqry: QryWzskShtRef1NFile.StatApp = QryWzskShtRef1NFile.StatApp()
		public var statshrqry: QryWzskShtRef1NFile.StatShr = QryWzskShtRef1NFile.StatShr()
		public var stgiacqry: QryWzskShtRef1NFile.StgIac = QryWzskShtRef1NFile.StgIac()
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskShtRef1NFileData")}
			valid = basexpath != nil
