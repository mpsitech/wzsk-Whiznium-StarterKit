/**
  * \file PnlWzskPrsRec.swift
  * Swift API code for job PnlWzskPrsRec
...
public class PnlWzskPrsRec {
	...
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskPrsRec")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskPrsRec"
	...
	public class StatApp: Block {
		...
		public static let INITDONEADETAIL: Int = 2

		public init(
					_ initdoneDetail: Bool = false
					, _ initdoneADetail: Bool = false
				) {
			self.initdoneDetail = initdoneDetail
			self.initdoneADetail = initdoneADetail

			super.init()

			mask = [StatApp.INITDONEDETAIL, StatApp.INITDONEADETAIL]
		}

		public var initdoneDetail: Bool
		public var initdoneADetail: Bool
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppWzskPrsRec")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppWzskPrsRec"

			if valid {
				initdoneDetail = Xmlio.extractBoolAttrUclc(doc, basexpath!, itemtag, "Ci", "sref", "initdoneDetail", &mask, StatApp.INITDONEDETAIL)
				initdoneADetail = Xmlio.extractBoolAttrUclc(doc, basexpath!, itemtag, "Ci", "sref", "initdoneADetail", &mask, StatApp.INITDONEADETAIL)
			}
		...
		public func comm(
			...
			if initdoneADetail == comp.initdoneADetail {items.insert(StatApp.INITDONEADETAIL)}
		...
		public func diff(
			...
			let commitems: Set<Int> = comm(comp)
			var diffitems: Set<Int> = [StatApp.INITDONEDETAIL, StatApp.INITDONEADETAIL]
	...
	public class StatShr: Block {
		...
		public static let SCRJREFADETAIL: Int = 3
		public static let BUTREGULARIZEACTIVE: Int = 4

		public init(
					_ ixWzskVExpstate: Int = 0
					, _ scrJrefDetail: String = ""
					, _ scrJrefADetail: String = ""
					, _ ButRegularizeActive: Bool = false
				) {
			self.ixWzskVExpstate = ixWzskVExpstate
			self.scrJrefDetail = scrJrefDetail
			self.scrJrefADetail = scrJrefADetail
			self.ButRegularizeActive = ButRegularizeActive

			super.init()

			mask = [StatShr.IXWZSKVEXPSTATE, StatShr.SCRJREFDETAIL, StatShr.SCRJREFADETAIL, StatShr.BUTREGULARIZEACTIVE]
		}

		public var ixWzskVExpstate: Int
		public var scrJrefDetail: String
		public var scrJrefADetail: String
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskPrsRec")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskPrsRec"
			...
			if valid {
				...
				scrJrefADetail = Xmlio.extractStringAttrUclc(doc, basexpath!, itemtag, "Ci", "sref", "scrJrefADetail", &mask, StatShr.SCRJREFADETAIL)
		...
		public func comm(
			...
			if scrJrefADetail == comp.scrJrefADetail {items.insert(StatShr.SCRJREFADETAIL)}
		...
		public func diff(
			...
			let commitems: Set<Int> = comm(comp)
			var diffitems: Set<Int> = [StatShr.IXWZSKVEXPSTATE, StatShr.SCRJREFDETAIL, StatShr.SCRJREFADETAIL, StatShr.BUTREGULARIZEACTIVE]
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskPrsRec")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskPrsRec"
	...
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKPRSRECDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskPrsRecDo")
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKPRSRECDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskPrsRecData")}
			valid = basexpath != nil
