/**
  * \file QryWzskSesList.swift
  * Swift API code for job QryWzskSesList
...
public class QryWzskSesList {
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskSesList")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskSesList"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskSesList")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskSesList"
	...
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskSesList")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskSesList"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskSesList"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskSesList"
