/**
  * \file PnlWzskPrsADetail.swift
  * Swift API code for job PnlWzskPrsADetail
...
/**
	* PnlWzskPrsADetail
	*/
public class PnlWzskPrsADetail {
	/**
		* VecVDo (full: VecVWzskPrsADetailDo)
		*/
	public class VecVDo {
	...
	/**
	  * ContInf (full: ContInfWzskPrsADetail)
	  */
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskPrsADetail")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskPrsADetail"
	...
	/**
	  * StatApp (full: StatAppWzskPrsADetail)
	  */
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppWzskPrsADetail")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppWzskPrsADetail"
	...
	/**
	  * StatShr (full: StatShrWzskPrsADetail)
	  */
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskPrsADetail")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskPrsADetail"
	...
	/**
	  * StgIac (full: StgIacWzskPrsADetail)
	  */
	public class StgIac: Block {

		public static let TCOTYPWIDTH: Int = 1
		...
		public init(
			...
			self.TcoTypWidth = TcoTypWidth
			self.TcoValWidth = TcoValWidth

			super.init()

			mask = [StgIac.TCOTYPWIDTH, StgIac.TCOVALWIDTH]
		}

		public var TcoTypWidth: Int
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacWzskPrsADetail")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacWzskPrsADetail"

			if valid {
				TcoTypWidth = Xmlio.extractIntAttrUclc(doc, basexpath!, itemtag, "Si", "sref", "TcoTypWidth", &mask, StgIac.TCOTYPWIDTH)
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacWzskPrsADetail"}

			let itemtag: String = shorttags ? "Si" : "StgitemacWzskPrsADetail"
			...
			Xmlio.writeIntAttr(doc, el, itemtag, "sref", "TcoTypWidth", TcoTypWidth)
		...
		public func comm(
			...
			if TcoTypWidth == comp.TcoTypWidth {items.insert(StgIac.TCOTYPWIDTH)}
		...
		public func diff(
			...
			let commitems: Set<Int> = comm(comp)
			var diffitems: Set<Int> = [StgIac.TCOTYPWIDTH, StgIac.TCOVALWIDTH]
	...
	public class Tag: Block {
		...
		public static let TCOTYP: Int = 7
		...
		public init(
			...
			mask = [Tag.CPT, Tag.TXTRECORD1, Tag.TXTRECORD2, Tag.TRS, Tag.TXTSHOWING1, Tag.TXTSHOWING2, Tag.TCOTYP, Tag.TCOVAL]
		}
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskPrsADetail")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskPrsADetail"
			...
			if valid {
				...
				TcoTyp = Xmlio.extractStringAttrUclc(doc, basexpath!, itemtag, "Ti", "sref", "TcoTyp", &mask, Tag.TCOTYP)
		...
		public func comm(
			...
			if TcoTyp == comp.TcoTyp {items.insert(Tag.TCOTYP)}
		...
		public func diff(
			...
			let commitems: Set<Int> = comm(comp)
			var diffitems: Set<Int> = [Tag.CPT, Tag.TXTRECORD1, Tag.TXTRECORD2, Tag.TRS, Tag.TXTSHOWING1, Tag.TXTSHOWING2, Tag.TCOTYP, Tag.TCOVAL]
	...
	/**
		* DpchAppData (full: DpchAppWzskPrsADetailData)
		*/
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
					_ scrJref: String = ""
					, _ stgiac: StgIac? = nil
					, _ stgiacqry: QryWzskPrsADetail.StgIac? = nil
					, mask: Set<Int> = []
				) {
			super.init(VecWzskVDpch.DPCHAPPWZSKPRSADETAILDATA, scrJref)
		...
		public var stgiacqry: QryWzskPrsADetail.StgIac = QryWzskPrsADetail.StgIac()
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskPrsADetailData")
	...
	/**
		* DpchAppDo (full: DpchAppWzskPrsADetailDo)
		*/
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKPRSADETAILDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskPrsADetailDo")
	...
	/**
		* DpchEngData (full: DpchEngWzskPrsADetailData)
		*/
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKPRSADETAILDATA)
		}
		...
		public var rst: ListWzskQPrsADetail = ListWzskQPrsADetail()
		public var statappqry: QryWzskPrsADetail.StatApp = QryWzskPrsADetail.StatApp()
		public var statshrqry: QryWzskPrsADetail.StatShr = QryWzskPrsADetail.StatShr()
		public var stgiacqry: QryWzskPrsADetail.StgIac = QryWzskPrsADetail.StgIac()
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskPrsADetailData")}
			valid = basexpath != nil
			...
			if valid {
				...
				stgiac = StgIac()
				tag = Tag()
				statappqry = QryWzskPrsADetail.StatApp()
				statshrqry = QryWzskPrsADetail.StatShr()
