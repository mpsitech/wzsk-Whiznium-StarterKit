/**
  * \file PnlWzskUsrHeadbar.swift
  * Swift API code for job PnlWzskUsrHeadbar
...
/**
	* PnlWzskUsrHeadbar
	*/
public class PnlWzskUsrHeadbar {
	/**
	...
	public class StgInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgInfWzskUsrHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "StgitemnfWzskUsrHeadbar"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskUsrHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskUsrHeadbar"
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKUSRHEADBARDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskUsrHeadbarData")}
			valid = basexpath != nil
