/**
  * \file PnlWzskSes1NShot.swift
  * Swift API code for job PnlWzskSes1NShot
...
/**
	* PnlWzskSes1NShot
	*/
public class PnlWzskSes1NShot {
	/**
		* VecVDo (full: VecVWzskSes1NShotDo)
		*/
	public class VecVDo {
	...
	/**
	  * ContInf (full: ContInfWzskSes1NShot)
	  */
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskSes1NShot")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskSes1NShot"
	...
	/**
	  * StatApp (full: StatAppWzskSes1NShot)
	  */
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppWzskSes1NShot")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppWzskSes1NShot"
	...
	/**
	  * StatShr (full: StatShrWzskSes1NShot)
	  */
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskSes1NShot")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskSes1NShot"
	...
	/**
	  * StgIac (full: StgIacWzskSes1NShot)
	  */
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacWzskSes1NShot")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacWzskSes1NShot"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacWzskSes1NShot"}

			let itemtag: String = shorttags ? "Si" : "StgitemacWzskSes1NShot"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskSes1NShot")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskSes1NShot"
	...
	/**
		* DpchAppData (full: DpchAppWzskSes1NShotData)
		*/
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
					_ scrJref: String = ""
					, _ stgiac: StgIac? = nil
					, _ stgiacqry: QryWzskSes1NShot.StgIac? = nil
					, mask: Set<Int> = []
				) {
			super.init(VecWzskVDpch.DPCHAPPWZSKSES1NSHOTDATA, scrJref)
		...
		public var stgiacqry: QryWzskSes1NShot.StgIac = QryWzskSes1NShot.StgIac()
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskSes1NShotData")
	...
	/**
		* DpchAppDo (full: DpchAppWzskSes1NShotDo)
		*/
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKSES1NSHOTDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskSes1NShotDo")
	...
	/**
		* DpchEngData (full: DpchEngWzskSes1NShotData)
		*/
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKSES1NSHOTDATA)
		}
		...
		public var rst: ListWzskQSes1NShot = ListWzskQSes1NShot()
		public var statappqry: QryWzskSes1NShot.StatApp = QryWzskSes1NShot.StatApp()
		public var statshrqry: QryWzskSes1NShot.StatShr = QryWzskSes1NShot.StatShr()
		public var stgiacqry: QryWzskSes1NShot.StgIac = QryWzskSes1NShot.StgIac()
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskSes1NShotData")}
			valid = basexpath != nil
