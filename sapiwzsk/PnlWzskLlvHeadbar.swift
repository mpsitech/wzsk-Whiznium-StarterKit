/**
  * \file PnlWzskLlvHeadbar.swift
  * Swift API code for job PnlWzskLlvHeadbar
...
/**
	* PnlWzskLlvHeadbar
	*/
public class PnlWzskLlvHeadbar {
	/**
	...
	public class StgInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgInfWzskLlvHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "StgitemnfWzskLlvHeadbar"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskLlvHeadbar")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskLlvHeadbar"
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKLLVHEADBARDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskLlvHeadbarData")}
			valid = basexpath != nil
