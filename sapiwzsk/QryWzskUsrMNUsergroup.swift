/**
  * \file QryWzskUsrMNUsergroup.swift
  * Swift API code for job QryWzskUsrMNUsergroup
...
/**
	* QryWzskUsrMNUsergroup
	*/
public class QryWzskUsrMNUsergroup {
	/**
	  * StatApp (full: StatAppQryWzskUsrMNUsergroup)
	  */
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskUsrMNUsergroup")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskUsrMNUsergroup"
	...
	/**
	  * StatShr (full: StatShrQryWzskUsrMNUsergroup)
	  */
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskUsrMNUsergroup")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskUsrMNUsergroup"
	...
	/**
	  * StgIac (full: StgIacQryWzskUsrMNUsergroup)
	  */
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskUsrMNUsergroup")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskUsrMNUsergroup"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskUsrMNUsergroup"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskUsrMNUsergroup"
