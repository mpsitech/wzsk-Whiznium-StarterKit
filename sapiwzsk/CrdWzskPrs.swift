/**
  * \file CrdWzskPrs.swift
  * Swift API code for job CrdWzskPrs
...
public class CrdWzskPrs {
	...
	public class ContInf: Block {
		...
		public static let MTXCRDPRS: Int = 3
		...
		public init(
			...
			self.MtxCrdPrs = MtxCrdPrs

			super.init()

			mask = [ContInf.NUMFSGE, ContInf.MRLAPPHLP, ContInf.MTXCRDPRS]
		}

		public var numFSge: Int
		public var MrlAppHlp: String
		public var MtxCrdPrs: String
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskPrs")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskPrs"
			...
			if valid {
				...
				MtxCrdPrs = Xmlio.extractStringAttrUclc(doc, basexpath!, itemtag, "Ci", "sref", "MtxCrdPrs", &mask, ContInf.MTXCRDPRS)
			}
		...
		public func comm(
			...
			if MtxCrdPrs == comp.MtxCrdPrs {items.insert(ContInf.MTXCRDPRS)}
		...
		public func diff(
			...
			var diffitems: Set<Int> = [ContInf.NUMFSGE, ContInf.MRLAPPHLP, ContInf.MTXCRDPRS]
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppWzskPrs")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppWzskPrs"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskPrs")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskPrs"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskPrs")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskPrs"
	...
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKPRSDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskPrsDo")
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKPRSDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskPrsData")}
			valid = basexpath != nil
