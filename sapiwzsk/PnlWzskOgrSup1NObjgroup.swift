/**
  * \file PnlWzskOgrSup1NObjgroup.swift
  * Swift API code for job PnlWzskOgrSup1NObjgroup
...
/**
	...
	*/
public class PnlWzskOgrSup1NObjgroup {
	/**
	...
	public class VecVDo {
		...
		public static let BUTREFRESHCLICK: Int = 2
	...
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskOgrSup1NObjgroup")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskOgrSup1NObjgroup"
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppWzskOgrSup1NObjgroup")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppWzskOgrSup1NObjgroup"
	...
	public class StatShr: Block {
		...
		public init(
			...
			mask = [StatShr.BUTVIEWAVAIL, StatShr.BUTVIEWACTIVE]
		}
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskOgrSup1NObjgroup")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskOgrSup1NObjgroup"
		...
		public func diff(
			...
			let commitems: Set<Int> = comm(comp)
			var diffitems: Set<Int> = [StatShr.BUTVIEWAVAIL, StatShr.BUTVIEWACTIVE]
	...
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacWzskOgrSup1NObjgroup")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacWzskOgrSup1NObjgroup"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacWzskOgrSup1NObjgroup"}

			let itemtag: String = shorttags ? "Si" : "StgitemacWzskOgrSup1NObjgroup"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskOgrSup1NObjgroup")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskOgrSup1NObjgroup"
	...
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
					_ scrJref: String = ""
					, _ stgiac: StgIac? = nil
					, _ stgiacqry: QryWzskOgrSup1NObjgroup.StgIac? = nil
					, mask: Set<Int> = []
				) {
			super.init(VecWzskVDpch.DPCHAPPWZSKOGRSUP1NOBJGROUPDATA, scrJref)
		...
		public var stgiacqry: QryWzskOgrSup1NObjgroup.StgIac = QryWzskOgrSup1NObjgroup.StgIac()
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskOgrSup1NObjgroupData")
	...
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKOGRSUP1NOBJGROUPDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskOgrSup1NObjgroupDo")
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKOGRSUP1NOBJGROUPDATA)
		}
		...
		public var rst: ListWzskQOgrSup1NObjgroup = ListWzskQOgrSup1NObjgroup()
		public var statappqry: QryWzskOgrSup1NObjgroup.StatApp = QryWzskOgrSup1NObjgroup.StatApp()
		public var statshrqry: QryWzskOgrSup1NObjgroup.StatShr = QryWzskOgrSup1NObjgroup.StatShr()
		public var stgiacqry: QryWzskOgrSup1NObjgroup.StgIac = QryWzskOgrSup1NObjgroup.StgIac()
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskOgrSup1NObjgroupData")}
			valid = basexpath != nil
			...
			if valid {
				...
				stgiac = StgIac()
				tag = Tag()
				statappqry = QryWzskOgrSup1NObjgroup.StatApp()
				statshrqry = QryWzskOgrSup1NObjgroup.StatShr()
