/**
  * \file PnlWzskUsrAAccess.swift
  * Swift API code for job PnlWzskUsrAAccess
...
/**
	* PnlWzskUsrAAccess
	*/
public class PnlWzskUsrAAccess {
	/**
	...
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskUsrAAccess")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskUsrAAccess"
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppWzskUsrAAccess")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppWzskUsrAAccess"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskUsrAAccess")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskUsrAAccess"
	...
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacWzskUsrAAccess")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacWzskUsrAAccess"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacWzskUsrAAccess"}

			let itemtag: String = shorttags ? "Si" : "StgitemacWzskUsrAAccess"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskUsrAAccess")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskUsrAAccess"
	...
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
					_ scrJref: String = ""
					, _ stgiac: StgIac? = nil
					, _ stgiacqry: QryWzskUsrAAccess.StgIac? = nil
					, mask: Set<Int> = []
				) {
			super.init(VecWzskVDpch.DPCHAPPWZSKUSRAACCESSDATA, scrJref)
		...
		public var stgiacqry: QryWzskUsrAAccess.StgIac = QryWzskUsrAAccess.StgIac()
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskUsrAAccessData")
	...
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKUSRAACCESSDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskUsrAAccessDo")
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKUSRAACCESSDATA)
		}
		...
		public var rst: ListWzskQUsrAAccess = ListWzskQUsrAAccess()
		public var statappqry: QryWzskUsrAAccess.StatApp = QryWzskUsrAAccess.StatApp()
		public var statshrqry: QryWzskUsrAAccess.StatShr = QryWzskUsrAAccess.StatShr()
		public var stgiacqry: QryWzskUsrAAccess.StgIac = QryWzskUsrAAccess.StgIac()
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskUsrAAccessData")}
			valid = basexpath != nil
