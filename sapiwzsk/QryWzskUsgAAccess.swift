/**
  * \file QryWzskUsgAAccess.swift
  * Swift API code for job QryWzskUsgAAccess
...
/**
	* QryWzskUsgAAccess
	*/
public class QryWzskUsgAAccess {
	/**
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskUsgAAccess")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskUsgAAccess"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskUsgAAccess")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskUsgAAccess"
	...
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskUsgAAccess")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskUsgAAccess"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskUsgAAccess"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskUsgAAccess"
