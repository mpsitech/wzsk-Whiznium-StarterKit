/**
  * \file PnlWzskSesRec.swift
  * Swift API code for job PnlWzskSesRec
...
public class PnlWzskSesRec {
	...
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskSesRec")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskSesRec"
	...
	public class StatApp: Block {
		...
		public init(
			...
			mask = [StatApp.INITDONEDETAIL, StatApp.INITDONE1NSHOT]
		}
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppWzskSesRec")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppWzskSesRec"
		...
		public func diff(
			...
			let commitems: Set<Int> = comm(comp)
			var diffitems: Set<Int> = [StatApp.INITDONEDETAIL, StatApp.INITDONE1NSHOT]
	...
	public class StatShr: Block {
		...
		public init(
			...
			mask = [StatShr.IXWZSKVEXPSTATE, StatShr.SCRJREFDETAIL, StatShr.SCRJREF1NSHOT, StatShr.BUTREGULARIZEACTIVE]
		}
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskSesRec")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskSesRec"
		...
		public func diff(
			...
			let commitems: Set<Int> = comm(comp)
			var diffitems: Set<Int> = [StatShr.IXWZSKVEXPSTATE, StatShr.SCRJREFDETAIL, StatShr.SCRJREF1NSHOT, StatShr.BUTREGULARIZEACTIVE]
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskSesRec")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskSesRec"
	...
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKSESRECDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskSesRecDo")
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKSESRECDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskSesRecData")}
			valid = basexpath != nil
