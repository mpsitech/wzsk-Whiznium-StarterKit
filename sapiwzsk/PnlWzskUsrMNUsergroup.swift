/**
  * \file PnlWzskUsrMNUsergroup.swift
  * Swift API code for job PnlWzskUsrMNUsergroup
...
public class PnlWzskUsrMNUsergroup {
	...
	public class ContInf: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskUsrMNUsergroup")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskUsrMNUsergroup"
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppWzskUsrMNUsergroup")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppWzskUsrMNUsergroup"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskUsrMNUsergroup")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskUsrMNUsergroup"
	...
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacWzskUsrMNUsergroup")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacWzskUsrMNUsergroup"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacWzskUsrMNUsergroup"}

			let itemtag: String = shorttags ? "Si" : "StgitemacWzskUsrMNUsergroup"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskUsrMNUsergroup")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskUsrMNUsergroup"
	...
	public class DpchAppData: DpchAppWzsk {
		...
		public init(
					_ scrJref: String = ""
					, _ stgiac: StgIac? = nil
					, _ stgiacqry: QryWzskUsrMNUsergroup.StgIac? = nil
					, mask: Set<Int> = []
				) {
			super.init(VecWzskVDpch.DPCHAPPWZSKUSRMNUSERGROUPDATA, scrJref)
		...
		public var stgiacqry: QryWzskUsrMNUsergroup.StgIac = QryWzskUsrMNUsergroup.StgIac()
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskUsrMNUsergroupData")
	...
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKUSRMNUSERGROUPDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskUsrMNUsergroupDo")
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKUSRMNUSERGROUPDATA)
		}
		...
		public var rst: ListWzskQUsrMNUsergroup = ListWzskQUsrMNUsergroup()
		public var statappqry: QryWzskUsrMNUsergroup.StatApp = QryWzskUsrMNUsergroup.StatApp()
		public var statshrqry: QryWzskUsrMNUsergroup.StatShr = QryWzskUsrMNUsergroup.StatShr()
		public var stgiacqry: QryWzskUsrMNUsergroup.StgIac = QryWzskUsrMNUsergroup.StgIac()
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskUsrMNUsergroupData")}
			valid = basexpath != nil
			...
			if valid {
				...
				stgiac = StgIac()
				tag = Tag()
				statappqry = QryWzskUsrMNUsergroup.StatApp()
				statshrqry = QryWzskUsrMNUsergroup.StatShr()
