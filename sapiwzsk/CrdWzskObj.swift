/**
  * \file CrdWzskObj.swift
  * Swift API code for job CrdWzskObj
...
public class CrdWzskObj {
	...
	public class ContInf: Block {
		...
		public static let MTXCRDOBJ: Int = 3
		...
		public init(
			...
			self.MtxCrdObj = MtxCrdObj

			super.init()

			mask = [ContInf.NUMFSGE, ContInf.MRLAPPHLP, ContInf.MTXCRDOBJ]
		}

		public var numFSge: Int
		public var MrlAppHlp: String
		public var MtxCrdObj: String
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "ContInfWzskObj")}
			valid = basexpath != nil

			let itemtag: String = "ContitemInfWzskObj"
			...
			if valid {
				...
				MtxCrdObj = Xmlio.extractStringAttrUclc(doc, basexpath!, itemtag, "Ci", "sref", "MtxCrdObj", &mask, ContInf.MTXCRDOBJ)
			}
		...
		public func comm(
			...
			if MtxCrdObj == comp.MtxCrdObj {items.insert(ContInf.MTXCRDOBJ)}
		...
		public func diff(
			...
			var diffitems: Set<Int> = [ContInf.NUMFSGE, ContInf.MRLAPPHLP, ContInf.MTXCRDOBJ]
	...
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppWzskObj")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppWzskObj"
	...
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrWzskObj")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrWzskObj"
	...
	public class Tag: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "TagWzskObj")}
			valid = basexpath != nil

			let itemtag: String = "TagitemzskObj"
	...
	public class DpchAppDo: DpchAppWzsk {
		...
		public init(
			...
			super.init(VecWzskVDpch.DPCHAPPWZSKOBJDO, scrJref)
		...
		public override func writeXML(
			...
			let el = XMLElement(name: "DpchAppWzskObjDo")
	...
	public class DpchEngData: DpchEngWzsk {
		...
		public init() {
			super.init(VecWzskVDpch.DPCHENGWZSKOBJDATA)
		}
		...
		public override func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "DpchEngWzskObjData")}
			valid = basexpath != nil
