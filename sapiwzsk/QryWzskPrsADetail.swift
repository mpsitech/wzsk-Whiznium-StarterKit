/**
  * \file QryWzskPrsADetail.swift
  * Swift API code for job QryWzskPrsADetail
...
/**
	* QryWzskPrsADetail
	*/
public class QryWzskPrsADetail {
	/**
	  * StatApp (full: StatAppQryWzskPrsADetail)
	  */
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskPrsADetail")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskPrsADetail"
	...
	/**
	  * StatShr (full: StatShrQryWzskPrsADetail)
	  */
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskPrsADetail")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskPrsADetail"
	...
	/**
	  * StgIac (full: StgIacQryWzskPrsADetail)
	  */
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskPrsADetail")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskPrsADetail"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskPrsADetail"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskPrsADetail"
