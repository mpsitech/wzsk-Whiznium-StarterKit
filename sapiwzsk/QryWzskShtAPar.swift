/**
  * \file QryWzskShtAPar.swift
  * Swift API code for job QryWzskShtAPar
...
/**
	* QryWzskShtAPar
	*/
public class QryWzskShtAPar {
	/**
	  * StatApp (full: StatAppQryWzskShtAPar)
	  */
	public class StatApp: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatAppQryWzskShtAPar")}
			valid = basexpath != nil

			let itemtag: String = "StatitemAppQryWzskShtAPar"
	...
	/**
	  * StatShr (full: StatShrQryWzskShtAPar)
	  */
	public class StatShr: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StatShrQryWzskShtAPar")}
			valid = basexpath != nil

			let itemtag: String = "StatitemShrQryWzskShtAPar"
	...
	/**
	  * StgIac (full: StgIacQryWzskShtAPar)
	  */
	public class StgIac: Block {
		...
		public func readXML(
			...
			if addbasetag {basexpath = Xmlio.checkUclcXPaths(doc, _basexpath, "StgIacQryWzskShtAPar")}
			valid = basexpath != nil

			let itemtag: String = "StgitemacQryWzskShtAPar"
		...
		public func writeXML(
			...
			if tag == nil {tag = "StgIacQryWzskShtAPar"}

			let itemtag: String = shorttags ? "Si" : "StgitemacQryWzskShtAPar"
