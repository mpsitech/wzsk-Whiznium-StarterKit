...
export set LIBROOT=/home/mpsitech/emb/mcv/wzsk/sdk/sysroots/cortexa9t2hf-neon-poky-linux-gnueabi${WHIZSDKROOT}/lib
export set BINROOT=/home/mpsitech/emb/mcv/wzsk/sdk/sysroots/cortexa9t2hf-neon-poky-linux-gnueabi${WHIZROOT}/bin
