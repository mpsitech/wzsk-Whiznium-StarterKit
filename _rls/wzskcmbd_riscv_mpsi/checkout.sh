#!/bin/bash
# file checkout.sh
# checkout script for Wzsk combined daemon, release wzskcmbd_riscv_mpsi (jack cross-compilation)
...
export set LIBROOT=/home/mpsitech/emb/icicle/wzsk/sdk/sysroots/riscv64-oe-linux${WHIZSDKROOT}/lib
export set BINROOT=/home/mpsitech/emb/icicle/wzsk/sdk/sysroots/riscv64-oe-linux${WHIZROOT}/bin
