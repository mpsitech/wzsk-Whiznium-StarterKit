#!/bin/bash
# file checkout.sh
# checkout script for Wzsk combined daemon, release wzskcmbd_pl64_mpsi (jack cross-compilation)
...
export set BUILDROOT=/home/mpsitech/emb/zudvk/wzsk/sdk/sysroots/aarch64-xilinx-linux${WHIZSDKROOT}/build
export set LIBROOT=/home/mpsitech/emb/zudvk/wzsk/sdk/sysroots/aarch64-xilinx-linux${WHIZSDKROOT}/lib
export set BINROOT=/home/mpsitech/emb/zudvk/wzsk/sdk/sysroots/aarch64-xilinx-linux${WHIZROOT}/bin
...
cp ../../wzskcmbd/SDK_Configuration/*.h $BUILDROOT/wzskcmbd/

cp ../../wzskcmbd/WzskcmbdUasrv.h $BUILDROOT/wzskcmbd/
cp ../../wzskcmbd/WzskcmbdUasrv.cpp $BUILDROOT/wzskcmbd/
