...
void WzskQObjList::writeJSON(
	...
	if (shorttags) {
		me["tit"] = Title;
		me["ogr"] = stubRefWzskMObjgroup;
	} else {
		me["Title"] = Title;
		me["stubRefWzskMObjgroup"] = stubRefWzskMObjgroup;
	};
};
...
void ListWzskQObjList::writeJSON(
			Json::Value& sup
			, std::string difftag
		) {
	if (difftag == "") difftag = "ListWzskQObjList";
